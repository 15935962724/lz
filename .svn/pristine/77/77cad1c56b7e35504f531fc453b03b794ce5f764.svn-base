...
int count=Mapabc.count(sql.toString());
...
<%
java.util.Enumeration enumer=Mapabc.find(sql.toString(),pos,25);
for(int index=1;enumer.hasMoreElements();index++)
{
  String sid=(String)enumer.nextElement();
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td>
    <input type=button value=查看 onclick="window.showModalDialog('http://channel.mapabc.com/openmap/map.jsp?id=<%=sid%>&uid=7246&eid=102341&w=600&h=500','','edge:raised;help:0;resizable:1;dialogWidth:620px;dialogHeight:558px;');">
