...
if(ps.length>0)
{
  ...
  for(int i=1;i<ps.length;i++)
  {
    ...
    totalnum+=Integer.valueOf(arr[1]);
  }
}
...
{
  out.print(teasession._rv._strR+"！");
}
out.print("　<a href='/html/jskxcbs/folder/14010980-1.htm'>[个人中心]   </a><a href='/html/jskxcbs/folder/14011125-1.htm'><img width='17px' src='/res/jskxcbs/structure/201401271414.png'>（<B><font color='red'>"+totalnum+"</font></B>）</a>　<a href='###' style='display:none' onclick=mt.show('/jsp/type/bbs/BBSEditSel.jsp?node="+teasession._nNode+"',1,innerHTML,300,400)>[发表贴子]</a>　<a href='/servlet/Logout?community="+teasession._strCommunity+"&nexturl=/'>[退出]</a>");
%>
