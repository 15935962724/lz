...
<div id="edit_BodyDiv">  <!--<div id="pathdiv"><%=node.getAncestor(teasession._nLanguage)%></div>-->
      <TABLE WIDTH="100%" BORDER="1px" CELLPADDING="5" CELLSPACING="0" bordercolor="#999999" class="section" style="border-collapse:collapse;">
   ...
   param=param+"&nexturl="+parameter;
          ...
          <TR id="TableCaption">
            <TD colspan="2"> 职位发布</TD>
          </TR>
          <TR>
            <TD width="100" ALIGN="right"><strong>选择职位模板</strong></TD>
            <TD> <SPAN>
          ...
          <TR>
            <TD ALIGN="right"><strong>* 职位名称</strong>
			</TD>
			<TD>
          ...
          <TR>
            <TD HEIGHT="11" ALIGN="right"><strong>* 所属机构&nbsp;</strong></TD>
            <TD HEIGHT="11"><select  class="edit_input" name="sltOrgId" style="WIDTH: 292px">
...
%>
          ...
          <TR>
            <TD HEIGHT="11" ALIGN="right" NOWRAP><strong>* 职位性质&nbsp;</strong></TD>
            <TD HEIGHT="11"> <SELECT  class="edit_input"  NAME="sltJobType">
                <OPTION VALUE = "-1">--请选择--</OPTION>
                <!--版本号：0001-->
<!--Action:2-->
...
<OPTION VALUE="实习" <%=getSelect(job.getSltJobType().equals("实习"))%>>实习</OPTION>
          ...
          <TR>
            <TD ALIGN="right" valign="top"><strong>* 职业类别&nbsp;</strong></TD>
...
%><option><%=enumerationOccId.nextElement()%></option><%}%>
          ...
          <TR>
            <TD ALIGN="right"><strong>月薪范围&nbsp;</strong></TD>
            <TD>
          ...
          <TR>
            <TD ALIGN="right" VALIGN="TOP"><strong>* 工作地区&nbsp;</strong></TD>
            <TD> <TABLE  class="edit_input" BORDER="0" CELLSPACING="0" CELLPADDING="0">
                <TR>
...
<OPTION VALUE="235">非洲</OPTION>
                  ...
                  <TD WIDTH="80" ALIGN="CENTER"> <INPUT NAME="btnAdd"  class="edit_button" TYPE="BUTTON" VALUE="添加" WIDTH="52" HEIGHT="20" BORDER="0" onClick="AddOption('Location', form1.sltAllLocId, form1.sltLocId, 0);return false;">
...
%><option><%=enumerationLocId.nextElement()%></option><%}%>
          ...
          <TR>
            <TD ALIGN="right"><strong>最低工作经验&nbsp;</strong></TD>
...
<OPTION VALUE="10"<%=getSelect(job.getSltReqWyearId()==10)%>>10年</OPTION>
          ...
          <TR>
            <TD ALIGN="right" VALIGN="top" NOWRAP><strong>* 职位描述及要求&nbsp;</strong></TD>
