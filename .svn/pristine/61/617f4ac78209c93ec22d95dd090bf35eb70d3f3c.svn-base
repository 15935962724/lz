...
<body>
<h1>商品管理</h1>
<form name="form2" action="/ShopProducts.do?repository=product/<%=product/10000%>&product=<%=product%>" method="post" enctype="multipart/form-data" target="_ajax" onsubmit="return mt.check(this)&&mt.show(null,0)">
...
<table id="tablecenter" cellspacing="0">
  ...
  <tr>
    <td>销售价</td>
    <td><input name="price" value="<%=MT.f(t.price)%>" onkeyup="clearNoNum(this)" alt="销售价"/></td>
  </tr>
