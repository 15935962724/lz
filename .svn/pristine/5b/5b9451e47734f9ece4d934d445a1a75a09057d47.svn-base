...
<input name='nexturl' type="hidden" value="/jsp/yl/shop/ExpExcelFuwushang2.jsp" />
<input name='act' type="hidden" value="uploadfile_fu" />
<table id="tablecenter">
	<tr><td >模板</td><td ><a href="/res/Excel/fuwushang2.xlsx">点击下载</a></td></tr>
