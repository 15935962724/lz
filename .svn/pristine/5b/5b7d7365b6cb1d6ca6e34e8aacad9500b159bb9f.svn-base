...
<table id="tablecenter" cellspacing="0" class="listtop">
	<tr>
		<td>请输入申请开票数量：</td>
		<td><input type="text" name="inputnum" id="inputnum"/></td>
		<td><input type="button" id='invoicebutton1' value="确认"></td>
	</tr>
	
	<tr>
		<td>或输入申请开票金额：</td>
		<td><input type="text" name="inputamount" id="inputamount"/></td>
		<td><input type="button" id='invoicebutton2' value="确认"></td>
	</tr>
...
mt.receive=function(v,n,h){
	...
	function fnconfirm(){
		...
		if(a==0){
			...
			var aa='/html/folder/18031328-1.htm';
