...
<!--1169716387126=我参与的讨论-->
<h1><%=r.getString(teasession._nLanguage, "1169716387126")+" ( "+count+" ) "%></h1>
...
<%
java.util.Enumeration e=BBSReply.findByMember(teasession._strCommunity,member,pos,25);
for(int i=1;e.hasMoreElements();i++)
{
  ...
  out.print("<td><a href='/html/bbs/"+node+"-"+teasession._nLanguage+".htm' target='_blank'>"+obj.getSubject(teasession._nLanguage)+" ("+obj.getCreator()+")</a>");
