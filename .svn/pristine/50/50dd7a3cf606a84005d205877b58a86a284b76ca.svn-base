...
r.add("/tea/resource/Scholar");

boolean flag=request.getParameter("PickNode")==null;

ListingDetail ld=ListingDetail.find(listingid,85,teasession._nLanguage);
...
<body>
<h1><%=r.getString(teasession._nLanguage, "Report")%><%=r.getString(teasession._nLanguage, "Detail")%></h1>
...
<input type="hidden" name="ListingType" value="85">
<table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
  <tr>
    ...
    <td>
      ...
      <%=r.getString(teasession._nLanguage, "Before")%><input name="subject_1"  class="edit_input"  value="<%=HtmlElement.htmlToText(ld.getBeforeItem("subject"))%>">
      <%=r.getString(teasession._nLanguage, "After")%><input name="subject_2" class="edit_input"   value="<%=HtmlElement.htmlToText(ld.getAfterItem("subject"))%>">
  ...
  <tr>
    <td><%=r.getString(teasession._nLanguage, "Scholar.media")%>:</td>
    <td>
      ...
      <%=r.getString(teasession._nLanguage, "Before")%><input name="media_1"  class="edit_input"  value="<%=HtmlElement.htmlToText(ld.getBeforeItem("media"))%>">
      <%=r.getString(teasession._nLanguage, "After")%><input name="media_2" class="edit_input"   value="<%=HtmlElement.htmlToText(ld.getAfterItem("media"))%>">
  ...
  <tr>
    ...
    <td>
      ...
      <%=r.getString(teasession._nLanguage, "Before")%><input name="father_1"  class="edit_input"  value="<%=HtmlElement.htmlToText(ld.getBeforeItem("father"))%>">
      <%=r.getString(teasession._nLanguage, "After")%><input name="father_2" class="edit_input"   value="<%=HtmlElement.htmlToText(ld.getAfterItem("father"))%>">
   ...
   <tr>
    <td><%=r.getString(teasession._nLanguage, "Scholar.locus")%>:</td>
    <td><input  id="CHECKBOX" type="CHECKBOX" name="locus" value="checkbox"  <%=getCheck(ld.getIstype("locus"))%>><%=r.getString(teasession._nLanguage, "Show")%>
      <%=r.getString(teasession._nLanguage, "Before")%><input name="locus_1"  class="edit_input"     value="<%=HtmlElement.htmlToText(ld.getBeforeItem("locus"))%>" type="text">
        <%=r.getString(teasession._nLanguage, "After")%><input name="locus_2" class="edit_input"    value="<%=HtmlElement.htmlToText(ld.getAfterItem("locus"))%>" type="text">
...
<!--副标题-->
   <tr>
    <td><%=r.getString(teasession._nLanguage, "Scholar.subhead")%>:</td>
    <td><input  id="CHECKBOX" type="CHECKBOX" name="subhead" value="checkbox"  <%=getCheck(ld.getIstype("subhead"))%>><%=r.getString(teasession._nLanguage, "Show")%>
      <%=r.getString(teasession._nLanguage, "Before")%><input name="subhead_1"  class="edit_input"     value="<%=HtmlElement.htmlToText(ld.getBeforeItem("subhead"))%>" type="text">
          <%=r.getString(teasession._nLanguage, "After")%><input name="subhead_2" class="edit_input"    value="<%=HtmlElement.htmlToText(ld.getAfterItem("subhead"))%>" type="text">
...
<!--作者-->
   <tr>
    <td><%=r.getString(teasession._nLanguage, "Scholar.author")%>:</td>
    <td><input  id="CHECKBOX" type="CHECKBOX" name="author" value="checkbox"  <%=getCheck(ld.getIstype("author"))%>><%=r.getString(teasession._nLanguage, "Show")%>
      <%=r.getString(teasession._nLanguage, "Before")%><input name="author_1"  class="edit_input"     value="<%=HtmlElement.htmlToText(ld.getBeforeItem("author"))%>" type="text">
      <%=r.getString(teasession._nLanguage, "After")%><input name="author_2" class="edit_input"    value="<%=HtmlElement.htmlToText(ld.getAfterItem("author"))%>" type="text">
   ...
   <tr>
    <td><%=r.getString(teasession._nLanguage, "Scholar.file")%>:</td>
    <td><input  id="CHECKBOX" type="CHECKBOX" name="file" value="checkbox"  <%=getCheck(ld.getIstype("file"))%>><%=r.getString(teasession._nLanguage, "Show")%>
      <%=r.getString(teasession._nLanguage, "Before")%><input name="file_1"  class="edit_input"     value="<%=HtmlElement.htmlToText(ld.getBeforeItem("file"))%>" type="text">
          <%=r.getString(teasession._nLanguage, "After")%><input name="file_2" class="edit_input"    value="<%=HtmlElement.htmlToText(ld.getAfterItem("file"))%>" type="text">
  ...
  <tr>
    <td><%=r.getString(teasession._nLanguage, "Scholar.logograph")%>:</td>
    <td><input  id="CHECKBOX" type="CHECKBOX" name="logograph" value="checkbox"  <%=getCheck(ld.getIstype("logograph"))%>><%=r.getString(teasession._nLanguage, "Show")%>
      <%=r.getString(teasession._nLanguage, "Before")%><input name="logograph_1" class="edit_input"    value="<%=HtmlElement.htmlToText(ld.getBeforeItem("logograph"))%>" type="text">
          <%=r.getString(teasession._nLanguage, "After")%><input name="logograph_2" class="edit_input"    value="<%=HtmlElement.htmlToText(ld.getAfterItem("logograph"))%>" type="text">
  ...
  <tr>
    ...
    <td>
      ...
      <%=r.getString(teasession._nLanguage, "Before")%><input name="content_1"  class="edit_input"  value="<%=HtmlElement.htmlToText(ld.getBeforeItem("content"))%>">
      <%=r.getString(teasession._nLanguage, "After")%><input name="content_2" class="edit_input"   value="<%=HtmlElement.htmlToText(ld.getAfterItem("content"))%>">
  ...
  <tr>
    <td><%=r.getString(teasession._nLanguage, "Scholar.time")%>:</td>
