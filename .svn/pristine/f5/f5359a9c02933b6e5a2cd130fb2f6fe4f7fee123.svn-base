...
<input type="button" value="历史文件查看" onClick="window.location='/jsp/criterion/DocViewItemfilehistory.jsp?item=<%=item%>&community=<%=community%>&nexturl=<%=nexturl%>';"/>
<input type="button" value="查看" onClick="window.location='/jsp/criterion/DocViewItem.jsp?item=<%=item%>&community=<%=community%>&nexturl=<%=nexturl%>';"/>
