...
<tr>
      ...
      <td > <select style="width:100">
<option value="0" selected>-----不限-----</option>
<option value="5"  SELECTED >0-100</option>
<option value="3"  >100-200</option>
<option value="2"  >200-400</option>
<option value="1"  >400-600</option>
<option value="1"  >600-1000</option>
</select>
      </td>
      <td ></td>
      <td > </td>
     ...
     <tr>
      <td nowrap>
酒店名称：</td>
      <td ><input type=text name="subject" value="" size="40">
      </td>
      <td ></td>
      <td> </td>
      </tr>
  </table>
   <input type="button" class="edit_button" id="edit_submit"    value="查询">
  </FORM>
