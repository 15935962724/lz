...
while(e.hasMoreElements())
{
 ...
 Inventory iobj = Inventory.find(Inventory.getInvid(gdobj.getCommunity(),nodeid,waridname));
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''" title="点击选中的记录,选择你要退货的采购单号"  onclick="f_button('<%=gdobj.getPaid()%>');"  style=cursor:pointer>
    <td width="1"><%=is %></td>
