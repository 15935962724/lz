...
<table cellpadding="0" cellspacing="0" bordercolor="0" id="tablecenter">
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td>广州铭华机动车测试设备有限公司</td>
	<td>未公告</td>
	<td><input name="button5" type=button value="查看详细" onClick="window.open('/jsp/cpcc/Announcement_1.jsp', '_blank','width=750,height=600,scrollbars=yes');"><input name="button2" type=button value="已公告 "></td>
  </tr>
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    <td><input type="checkbox" name="trades" value=""/></td>
    <td>2007SRBJ5641</td>
