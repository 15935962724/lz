...
<frameset id="frame" rows="111,*"  frameborder="NO" border="0" framespacing="0">
  <frame src="index_headpho.jsp?community=<%=teasession._strCommunity%>&url=<%=java.net.URLEncoder.encode(desktop,"UTF-8")%>" name="topFrame" id="topFrame" marginheight="10" scrolling="NO" noresize>
