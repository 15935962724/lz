...
<TABLE boder="0" CELLSPACING=0 CELLPADDING=0 id="tablecenter">
  ...
  <TR>
    ...
    <TD><%=new CountrySelection("bCountry",teasession._nLanguage,trade.getbCountry(teasession._nLanguage))%></TD>
  </TR>
  <TR>
...
<TABLE boder="0" CELLSPACING=0 CELLPADDING=0 id="tablecenter">
  ...
  <TR>
    ...
    <td ID=RowHeader>国家:</TD>
    <TD><%=new CountrySelection("sCountry",teasession._nLanguage,trade.getsCountry(teasession._nLanguage))%></TD>
  </TR>
  <TR>
    <td ID=RowHeader>电话:</TD>
