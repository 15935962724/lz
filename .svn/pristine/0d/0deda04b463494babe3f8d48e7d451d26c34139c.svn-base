...
//String cc ="ccc";
//
//out.print(bb.indexOf(aa));
//
//out.print(bb.indexOf(cc));
%>
<html>
<head>
...
function f_xuanze()
{
  ...
  var rs = window.showModalDialog('/jsp/erp/semi/SemiCatecargo2_2.jsp?waridname='+form1.waridname.value+'&rsgoods='+form1.rsgoods.value,self,'edge:raised;scroll:0;status:0;help:0;resizable:0;dialogWidth:857px;dialogHeight:605px;');
...
{
  sendx("/jsp/erp/semi/SemiGoods_ajax_2.jsp?act=ggDetails&type=10&obid="+obid+"&purchase="+form1.purchase.value,
  function(data)
  {
...
{
  sendx("/jsp/erp/semi/GoodsGZ_ajax.jsp?act=gDetails&type=10&node="+igd+"&purchase="+form1.purchase.value,
  function(data)
  {
    if(data!=''&&data.length>1)
    {
...
function l_ajax(num){
  ...
  sendx("/jsp/erp/semi/SemiCatecargo_ajax2_2.jsp?act=EditPurchase&type=10"+stt+"&purid="+form1.purchase.value+"&puridsg="+form1.puridsg.value,
  function(data)
  {
...
function l_ajax2(num){
  ...
  sendx("/jsp/erp/semi/SemiCatecargo_ajax3.jsp?act=EditSemiCatecargo&type=10"+stt+"&purid="+form1.purchase.value+"&puridsg="+form1.puridsg.value,
  function(data)
  {
...
<div id="lzi_rkd">
  ...
  <input type="hidden" name="act" value="EditSemiCatecargo"/>
