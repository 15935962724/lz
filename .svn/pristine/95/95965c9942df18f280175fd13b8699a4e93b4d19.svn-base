...
{
  if(act=="ajax_opinion")dt="/118,119,120/121,122,123/";
...
if(dtw.indexOf("/118/")!=-1)
  out.println("<input type='button' value='填写意见' onclick=f_opinion('/118/119/120/') />");
else if(dtw.indexOf("/121/")!=-1)
  out.println("<input type='button' value='填写意见' onclick=f_opinion('/121/122/123/') />");
//else if(dtw.indexOf("/124/")!=-1)
//  out.println("<input type='button' value='填写意见' onclick=f_opinion('/124/125/126/') />");
//else if(dtw.indexOf("/128/")!=-1)
//  out.println("<input type='button' value='填写意见' onclick=f_opinion('/128/129/130/') />");
//else if(dtw.indexOf("/132/")!=-1)
//  out.println("<input type='button' value='填写意见' onclick=f_opinion('/132/133/134/') />");
//else if(dtw.indexOf("/136/")!=-1)
//  out.println("<input type='button' value='填写意见' onclick=f_opinion('/136/137/138/') />");

//会签
if(dtw.indexOf("/124/")!=-1)//公司分管协管领导批示
{
  out.println("<input type='button' value='填写意见' onclick='f_csign(124)' />");
}else if(dtw.indexOf("/127/")!=-1)//公司领导传阅
{
  out.println("<input type='button' value='填写意见' onclick='f_csign(127)' />");
}else if(dtw.indexOf("/131/")!=-1)//各部门传阅
{
  out.println("<input type='button' value='填写意见' onclick='f_csign(131)' />");
}else if(dtw.indexOf("/135/")!=-1)//承办部门办理结果
{
  out.println("<input type='button' value='填写意见' onclick='f_csign(135)' />");
}else if(dtw.indexOf("/617/")!=-1)//承办部门领导批示
{
  out.println("<input type='button' value='填写意见' onclick='f_csign(617)' />");
}
...
<input type="text" name="dynamictype583" disabled="disabled" />
<input type="text" name="dynamictype118" disabled="disabled" />
<input type="text" name="dynamictype119" disabled="disabled" />
<input type="text" name="dynamictype120" disabled="disabled" />
<input type="text" name="dynamictype121" disabled="disabled" />
<input type="text" name="dynamictype122" disabled="disabled" />
<input type="text" name="dynamictype123" disabled="disabled" />
<input type="text" name="dynamictype124" disabled="disabled" />
<input type="text" name="dynamictype127" disabled="disabled" />
<input type="text" name="dynamictype131" disabled="disabled" />
<input type="text" name="dynamictype135" disabled="disabled" />
</div>
<!-- -end-->
...
<input type="button" name="print" id="print"  value="收文处理签" <%if(ist.equals("1"))out.print("class='curbut'");%> onClick="getXx(this);"/>
...
<table id="tabbase"  <%if(ist.equals("1"))out.print("style='display:none'");%>>
  <tr>
    ...
    <td id="td117"><input type="text" name="dynamictype117" id="dynamictype117"/></td>
  </tr>
  ...
  <tr>
    ...
    <td style="padding:0px;border:0px;border-right:1px solid #ABAEB3;">
      <table id="tabbase_nei" border="0" cellspacing="0" cellpadding="0">
        <tr class="out2">
          <td class="tabtdteshu" id="td115"><input type="text" name="dynamictype115" /></td>
          <td class="tdtitle">文号</td>
          <td id="td116"><input type="text" readonly="readonly" style="background:transparent;border:0;width:90%;" name="dynamictype116"/></td>
        </tr>
      </table>
</td>
  </tr>
  <tr>
    <td class="tdtitle" style="border-right:0px;">备注</td>
    <td style="padding:0px;border:0px;border-right:1px solid #ABAEB3;">
      <table id="tabbase_nei" border="0" cellspacing="0" cellpadding="0">
        <tr class="out2">
          <td class="tabtdteshu" id="td139"><input type="text" name="dynamictype139" /></td>
          <td class="tdtitle">收文日期</td>
          <td id="td114"><input type="text" name="dynamictype114" onclick='showCalendar(this,true)' readonly='true' /></td>
        </tr>
      </table>
</td>
  </tr>
...
//10 pstep
%>
<area shape="rect" coords="155,7,253,34" href="###" id="1"/>
<area shape="rect" coords="155,77,253,104" href="###" id="2"/>
<area shape="rect" coords="155,149,253,176" href="###" id="1" pstep="/2/"/>
<area shape="rect" coords="155,224,253,251" href="###" id="3"/>
<area shape="rect" coords="155,294,253,321" href="###" id="1" pstep="/3/"/>
<area shape="rect" coords="155,366,253,407" href="###" id="4"/>
<area shape="rect" coords="155,454,253,481" href="###" id="1" pstep="/4/"/>
<area shape="rect" coords="22,527,120,554" href="###" id="5"/>
<area shape="rect" coords="156,527,254,554" href="###" id="6"/>
<area shape="rect" coords="307,527,405,554" href="###" id="7"/>
<area shape="rect" coords="306,595,404,622" href="###" id="8"/>
<area shape="rect" coords="155,596,253,623" href="###" id="1" pstep="/5/6/8/"/>
<area shape="rect" coords="155,666,253,693" href="###" id="9"/>
</map>
</div>
<script type="">
