...
<input type="radio" name="type" value="1" checked="checked">&nbsp;履友</div>
 <table border="0" cellpadding="0" cellspacing="0" class="regtable" id="tablecenter">
    ...
    <tr>
     ...
     <tr>
      ...
      <td>
       	<input type="text"    class="edit_input" name="card" onfocus="mt.f_card(this)" onblur="mt.f_card(this)" alt="身份证"><span id="card_info"><font>请填写您真实身份证号，否则将无法领取奖品</font></span>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      {
        out.print("<option value="+i+">"+Profile.WST_TYPE[i]);
      }*/
      %>
      </select>
      </td>
     ...
     <tr>
      ...
      <%} %>
   		...
   		<span id="belsellid" style="display:none"><br>
   			销售员姓名：<input type="text"    name="belsell" value=""  onfocus="mt.f_belsell(this)" onblur="mt.f_belsell(this)" alt="销售员姓名"><span id="belsell_info"></span><br>
   			销售员手机号：<input type="text"     name="tjmobile" value=""  onfocus="mt.f_belsellphone(this)" onblur="mt.f_belsellphone(this)" alt="销售员手机号"><span id="tjmobile_info"></span>
 ...
 <table border="0" cellpadding="0" cellspacing="0" id="tablecenter" >
    ...
    <tr>
      ...
      <td>
	      <input type="radio" name="sfshanggang" value="0" checked="checked">&nbsp;是
 ...
 <tr>
      ...
      {LvyouModels model=(LvyouModels)modelist.get(i);
        out.print("<input type='checkbox' name='wstmodel' value='"+model.getName()+"' id='_wstmodel"+i+"'><label for='_wstmodel"+i+"'>"+model.getName()+"</label>　");
      }

      /*
      for(int i=1;i<Profile.WST_MODEL.length;i++)
      {
        out.print("<input type='checkbox' name='wstmodel' value='"+Profile.WST_MODEL[i]+"' id='_wstmodel"+i+"'><label for='_wstmodel"+i+"'>"+Profile.WST_MODEL[i]+"</label>　");
      }*/
      %>
      </td>
    </tr>
