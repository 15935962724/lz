...
<input type="hidden" name="paystate" value="<%=obj.getPaystate()%>" />
...
<%
out.println("<input type=submit value=提交订单 >");
if(obj.getPaystate()<2)
{
  out.println("<input type=submit value=审核财务信息 onclick='form1.paystate.value=2;'>");
}
