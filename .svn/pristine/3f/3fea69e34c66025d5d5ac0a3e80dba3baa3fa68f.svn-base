...
<html>
<head><title>企业年金管理信息系统</title>
<link href='cssjs/style2.css' rel='stylesheet' type='text/css'>
<script src='cssjs/Globals.js'></script>
...
//||  !fcheck(obj.atc001)
 ...
 <base target = '_self'>
	...
	<table class=navigation>
		<tr>
			<td  onmousemove="this.title='';this.style.color='#FF0000'"  onmouseout="this.style.color='#000000';" >◆	年金养老金计算</td>
		</tr>
</TABLE>
	<!--录入部分-->
	<table class=tableTitle>
		<tr>
			<td style='word-break:keep-all'>年金养老金计算</td>
		</tr>
</TABLE>

	<form name="CalPensionForm" method="POST" action="<%=request.getRequestURI()%>" onSubmit="return checkValue(this);">
	...
	<tr>
	<!-- 	<td><font color='#FF0000'>*</font>缴费月增长率%</td><td colspan="1"><textarea style='width:100%'  name="gkrise" mask="nnn.nn" label="缴费月增长率%" required="true" disable="false" cols="20" rows="1" class="mask"></textarea></td>-->
		<td><font color='#FF0000'>*</font>工资年增长率%</td><td colspan="1"><textarea style='width:100%'  name="wagerise" mask="nnn.nnnn" label="工资年增长率%" required="true" disable="false" cols="20" rows="1" class="mask"><%if(post)out.print(request.getParameter("wagerise"));%></textarea></td>
	...
	<tr>
	<!-- 	<td><font color='#FF0000'>*</font>通货膨胀率%</td><td colspan="1"><textarea style='width:100%'  name="thpzl" mask="nn" label="通货膨胀率%" required="true" disable="false" cols="20" rows="1" class="mask"></textarea></td>-->
...
<!-- 	<tr>
	...
	<tr>
	<td nowrap>年金养老金(一次性领取)</td><td colspan="1"><input type = 'hidden' name='total' value="<%if(post)out.print((sn));%>" /><label><%if(post&&sn!=null)out.print("&yen; "+nf.format(sn.setScale(2,4)));%></label></td>
		<td nowrap>年金养老金(每月)</td><td colspan="1"><input type = 'hidden' name='replace' value="<%if(post)out.print((p4));%>" /><label><%if(post&&p4!=null)out.print("&yen; "+nf.format(p4));%></label></td>
		<!-- <td colspan="2" >&nbsp;</td>-->
	</tr>
</table>
</form>

<table class='tableInput' width='95%' height='35' border='0' align='center' cellspacing='0' ><tr><td><table width='140' height='31' border='0' align='right' cellpadding='0' cellspacing='0'>
  <tr>
  <td><input class='buttonGray' type='button' onClick="epamsaccount(document.forms[0])" value='计算'>&nbsp;&nbsp;&nbsp;&nbsp;
    <input class='buttonGray' type='button' onClick="clearForm(document.forms[0])" value='重置'>&nbsp;&nbsp;&nbsp;&nbsp;
  </td></tr></table></td></tr></table>
  <table width='95%' height='1' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td height='1' class='BottomlineColor'></td></tr></table>
</body>
</html>
