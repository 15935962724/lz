...
<input  id=CHECKBOX type="CHECKBOX" name="r_delete_4"   <%=getCheck(ld.getAnchor("r_delete"))%>><%=r.getString(teasession._nLanguage, "Anchor")%>
  ...
  function fshow()
  {
      ...
      {
          if(form1.elements[counter].type=="checkbox"&&form1.elements[counter].ld.substring(form1.elements[counter].ld.length-2)!="_4")
          {
  ...
  }function fafter()
  {
      for(var counter=0;counter<form1.elements.length;counter++)
      {
          if(form1.elements[counter].type=="text"&&form1.elements[counter].ld.substring(form1.elements[counter].ld.length-1)=="2")
          {
  ...
  function fbefore()
  {
      for(var counter=0;counter<form1.elements.length;counter++)
      {
          if(form1.elements[counter].type=="text"&&form1.elements[counter].ld.substring(form1.elements[counter].ld.length-1)=="1")
          {
