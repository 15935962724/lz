...
if(teasession._rv!=null)
{
  ...
  {
    teasession._nNode = ((Integer) fbt_enumer.nextElement()).intValue();
    if(tea.entity.node.Node.find(teasession._nNode).getCreator().equals(teasession._rv))
    {
      break;
    }else
    teasession._nNode=0;
...
String password=null,FirstName=null,Email=null,Mobile=null,telephone=null,age=null,nationality=null,address=null,school=null,degree=null;
boolean sex=true;
long len=0;
int polity=0;
if(teasession._rv!=null)
{
  ...
  age="";
  nationality =profile.getState(teasession._nLanguage);
 address= profile.getAddress(teasession._nLanguage);
 school= profile.getSchool(teasession._nLanguage);
...
if(_strPhotopath!=null)
{
 ...
 polity=profile.getPolity();
degree= profile.getDegree(teasession._nLanguage);
}else
{
password=FirstName=Email=Mobile=telephone=age=nationality=address=school=degree="";
}
...
function alteroption(big,small)
{
  ...
  //  var index=big.options[big.selectedIndex].value;
    ...
    {
      <%java.util.Enumeration smallOccScript,bigOccScript=tea.entity.site.Occupation.findByFather(Occupation.getRootId(community));
      int occ;
...
/*
          var strTemp = document.all['price'].value;
          if (strTemp.length == 0|| isNaN(parseFloat(strTemp)) )
          {
            alert("请正确填写 充值人民币！");
...
<body>
  ...
  <FORM name="Form1" METHOD=POST action="/servlet/EditClient" >
    ...
    out.print("<input type='hidden' name=nexturl value="+parameter+">");
        ...
        }else
        {
         ...
         summary=tea.entity.node.Client.find(teasession._nNode,teasession._nLanguage);
       }
            %>
...
<table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
      ...
      <tr>
        <td align="right"><div>
          <div><strong>* 用户ID&nbsp;&nbsp; </strong></div>
        </div></td>
        <td><input type="TEXT" class="edit_input"   <%if(teasession._rv!=null)out.print("readonly");%> name=Resume value="<%=getNull(summary.getName())%>" size=20 maxlength=20> </td>
      </tr>
	        <tr>
        <td align="right"><div><strong>* 密码&nbsp;&nbsp; </strong></div></td>
        <td><input  name=pw type="password" class="edit_input" value="<%=password%>" size=20 maxlength=20 > </td>
      </tr>
      <tr>
        <td align="right"><div><strong>* 姓名&nbsp;&nbsp; </strong></div></td>
        <td> <input type="TEXT" class="edit_input"  name=FirstName VALUE="<%=FirstName%><%//=getNull(profile.getLastName(teasession._nLanguage))%>" SIZE=20 MAXLENGTH=20>
      ...
      <tr>
        ...
        <td><span id="gender">
          <input  id="radio" type="radio" name="gender" value="1" checked / id="radio">
          <label for="gender_0">男&nbsp;</label>
          <input  id="radio" type="radio" name="gender" value="0" <%=getCheck(sex)%>/ id="radio">
      ...
      <tr>
        <td align="right"><strong><%--=r.getString(teasession._nLanguage, "Handset")--%>
          手机&nbsp;&nbsp;</strong></td>
        <td><input type="TEXT" class="edit_input"  name=Mobile  VALUE="<%=Mobile%>" SIZE=40 MAXLENGTH=40></td>
      </tr>
            <tr>
        <td align="right"><strong><%--=r.getString(teasession._nLanguage, "Handset")--%>
          电话&nbsp;&nbsp;</strong></td>
        <td><input type="TEXT" class="edit_input"  name=telephone  VALUE="<%=telephone%>" SIZE=40 MAXLENGTH=40></td>
      </tr>
      <tr>
        <td align="right"><span class="alert"><strong>*</strong></span><strong>年龄&nbsp;&nbsp;</strong></td>
        <td><input type="TEXT" class="edit_input"  name=age  VALUE="<%=age%>" >
        </td>
      </tr>
      <tr>
        <td align="right"><div><strong>照片&nbsp;&nbsp;</strong></div></td>
...
<br>尺寸：90X120 pixels
      ...
      <tr>
        ...
        <td><input class="edit_input" name="NationalityCN" id="NationalityCN" type="text" maxlength="20" size="20" value="<%=nationality%>" />
                  政治面貌&nbsp;&nbsp;<%
        tea.html.DropDown select=new tea.html.DropDown("polity",polity);
        for(int index=0;index<tea.entity.member.Profile.POLITY_TYPE.length;index++)
        {
          select.addOption(index,r.getString(teasession._nLanguage,tea.entity.member.Profile.POLITY_TYPE[index]));
        }
      ...
      <tr>
        ...
        <td>
          <TEXTAREA name="Address" class="edit_input" ROWS="2" COLS="60"><%=address%></TEXTAREA> </td>
      </tr>
      <TR>
        <TD></TD>
...
&nbsp;&nbsp;<span class="note">请填写你居住的城市</span> </td>
      ...
      <tr>
        ...
        <td><font size="2"><%=new tea.htmlx.DegreeSelection("Degree",degree)%>
          </font>&nbsp;
          <b>* 毕业学校</b><input class="edit_input" value="<%=school%>" name="school" id="OtherCityCN" type="text" size="50" maxlength="50" />
        </td>
      </tr><!--
      <tr>
        <td><div><strong> 教育背景&nbsp;&nbsp;</strong></div></td>
      ...
      <tr>
        <td><div><strong> 工作经验&nbsp;&nbsp;</strong></div></td>
      ...
      <%---
      <tr>
        <td><div><strong> \u00BD\u00CC\u00D3\u00FD±\u00B3\u00BE°&nbsp;&nbsp;</strong></div></td>
      ...
      <tr>
        <td><div><strong> \u00B9¤×÷\u00BE\u00AD\u00D1é&nbsp;&nbsp;</strong></div></td>
      ...
      -----%>
      <%--tr>
        <TD><strong>*</strong></span> 充值  <strong> </TD><td><input type="text" value="<%=getNull(summary.getPrice())%>" name="price"></td>
      </tr--%>
    </table>
    <table class="section" cellSpacing="0" cellPadding="0" border="0">
      ...
      <tr>
        <td vAlign="baseline" width="130"><span class="alert"><strong>*&nbsp;</strong></span><strong>现从事行业</strong></td>
      ...
      <tr>
        <td vAlign="baseline"><strong><nobr>*&nbsp;现从事职业&nbsp;&nbsp;</nobr></strong></td>
        <td><span class="note">
<%--
...
Form1.NowCareer.remove(index-1);
              ...
              <span class="note"><nobr>学生请选择“在校学生”</nobr><br></td>
      </tr>
      <tr>
        <td vAlign="baseline"><span class="alert"><strong>*</strong></span><strong>&nbsp;现职位级别&nbsp;&nbsp;</strong></td>
...
&nbsp;<span class="note"><span class="note">学生请选择“在校学生”</span><br>
      ...
      <tr>
        <td vAlign="baseline"><span class="alert"><strong>*&nbsp;</strong></span><strong>工作经验&nbsp;&nbsp;</strong></td>
      ...
      <tr>
        <td vAlign="baseline"><span class="alert"><strong>*</strong></span><strong>&nbsp;是否有海外工作经历&nbsp;&nbsp;</strong></td>
        <td><table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
            <tr>
              <td><input  id="radio" type="radio" name="Has_Abroad" value="True" <%=getCheck(summary.isHasAbroad())%> / id="radio">
                <label for="Has_Abroad_0">是 </label></td>
              <td><input  id="radio" type="radio" name="Has_Abroad" value="False"  <%=getCheck(!summary.isHasAbroad())%> / id="radio">
      ...
      <tr>
        <td vAlign="baseline"><strong>目前月薪（税前）&nbsp;&nbsp;</strong></td>
        <td>
   ...
   <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
      <tr id="TableCaption">
        <td colspan="4" vAlign="baseline"><div align="left"><span >求职意向</span></div></td>
      </tr>
      <tr>
        <td vAlign="baseline" width="130"><span class="alert"><strong>*</strong></span><strong>&nbsp;期望工作性质</strong></td>
        <td colSpan="3"><table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
            <tr>
              <td><input  id="CHECKBOX" type="CHECKBOX" name="ExpectWorkKind:0" <%=getCheck((summary.getExpectWorkKind()&2)!=0)%> / id="radio">
                <label for="ExpectWorkKind_0">全职</label></td>
              <td><input  id="CHECKBOX" type="CHECKBOX" name="ExpectWorkKind:1" <%=getCheck((summary.getExpectWorkKind()&4)!=0)%>/ id="radio">
                <label for="ExpectWorkKind_1">兼职</label></td>
              <td><input  id="CHECKBOX" type="CHECKBOX"  <%=getCheck((summary.getExpectWorkKind()&8)!=0)%>name="ExpectWorkKind:2" / id="radio">
                <label for="ExpectWorkKind_2">临时</label></td>
              <td><input <%=getCheck((summary.getExpectWorkKind()&16)!=0)%>  id="CHECKBOX" type="CHECKBOX" name="ExpectWorkKind:3" / id="radio">
      ...
      <%--
      <tr>
        <td vAlign="top" noWrap><strong>期望从事行业&nbsp;&nbsp;<br>
          （可选5项）&nbsp;&nbsp;</strong> </td>
      ...
      <TR>
        <TD vAlign="top" rowSpan="2"><span class="alert"><strong>*</strong></span><strong>&nbsp;期望从事职业&nbsp;&nbsp;<br>
          （可选5项）&nbsp;&nbsp;</strong></TD>
      ...
      <tr>
        <td vAlign="top"><select class="edit_input" id="srcExpectCareer" style="WIDTH: 160px" multiple size="5" name="srcExpectCareer"> </select></td>
      ...
      <tr>
        <td vAlign="baseline" rowSpan="2"><span class="alert"><strong>*</strong></span><strong>&nbsp;期望工作地区&nbsp;&nbsp;<br>
          （可选5项）&nbsp;&nbsp;</strong></td>
        <td colSpan="3"><select id="ExpectState" name="ExpectState"> </select>
          </FONT> </td>
      </tr>
      <tr>
        <td vAlign="top"><select class="edit_input" id="srcExpectCity" style="WIDTH: 160px" multiple size="5" name="srcExpectCity"> </select>
          </FONT> </td>
        <td><input class="edit_button" id="btnAddExpectCity" style="WIDTH: 60px" type="button" value="添加&gt;&gt;" name="btnAddExpectCity">
          <br>
          <input class="edit_button" id="btnDelExpectCity" style="WIDTH: 60px" type="button" value="&lt;&lt;删除" name="btnDelExpectCity"></td>
      ...
      <tr>
        <td vAlign="baseline"><strong>期望月薪（税前）&nbsp;&nbsp;</strong></td>
        <td colSpan="3">
      ...
      <tr>
        <td vAlign="baseline"><strong>到岗时间&nbsp;&nbsp;</strong></td>
...
if(lang3Objs[0]!=null) lang3Objs[0].onchange=function()
{
    ...
    <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
      <tr>
        <td valign="top" ><span class="alert"><strong>*&nbsp;</strong></span><strong>自我评价&nbsp;&nbsp;</strong></td>
        <td> <span class="note">
          ...
          （限200字。 <a id="linkSelfValueCN" href="javascript:alert(&quot;现已输入了&quot;+document.all['SelfValueCN'].value.length+&quot;个字！&quot;);">计算字数</a>）
      ...
      <tr>
        <td valign="top"><strong>职业目标&nbsp;&nbsp;</strong></td>
        <td><span class="note">
          <textarea class="edit_input" name="ObjectCN" rows="7" cols="60" id="ObjectCN"><%=summary.getSelfAim()%></textarea>
          <br>
          让招聘单位了解你的职业方向。（限500字。 <a id="linkObjectCN" href="javascript:alert(&quot;现已输入了&quot;+document.all['ObjectCN'].value.length+&quot;个字！&quot;);">计算字数</a>）<span id="valObject" controltovalidate="ObjectCN" errormessage="职业目标限500个字！" display="Dynamic" evaluationfunction="RegularExpressionValidatorEvaluateIsValid" validationexpression="(.|\n){0,500}" style="color:Red;display:none;">业目标限500个字！</span>
          </span> </td>
      </tr>
    </table>
    <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
      <tr>
        <td valign="top" ><span class="alert"></span><strong>奖励和其它&nbsp;&nbsp;</strong></td>
        <td>          <textarea class="edit_input" name="other" rows="5" cols="60" id="textarea"><%=getNull(summary.getOther())%></textarea>
          <br>
          概述你的奖励或其它优势。
          （限200字。 <a id="linkSelfValueCN" href="javascript:alert(&quot;现已输入了&quot;+document.all['other'].value.length+&quot;个字！&quot;);">计算字数</a>）<br>
</td>
      </tr>
    </table>
    <P ALIGN=CENTER>
     <input class="edit_button"  name="Educate" VALUE="教育背景" type="submit" onClick="return save_onclick();"><!--- onclick="window.open('EditEducate.jsp?<%=educateParam%>')">-->
     <input class="edit_button" name="Employment" VALUE="工作经验" type="submit" onClick="return save_onclick();"><!-- onclick="window.open('EditEmployment.jsp?<%=educateParam%>')">-->
