...
ListingDetail ld=ListingDetail.find(iListing,37,teasession._nLanguage);
...
<body>
<h1><%=r.getString(teasession._nLanguage, "Event")%><%=r.getString(teasession._nLanguage, "Detail")%></h1>
...
<input type='hidden' name="Node" value="<%=iNode%>">
    <input type="hidden" name="ListingType" value="37"/>
    <%if(!flag){%>
...
<%   }%>
  ...
  <tr>
   ...
   <tr>
    <td align="right"><%=r.getString(teasession._nLanguage, "活动副标题")%>: </td>
    <td>
  ...
  <tr>
    <td align="right"><%=r.getString(teasession._nLanguage, "活动开始时间")%>:</td>
  ...
  <tr >
    <td align="right"><%=r.getString(teasession._nLanguage, "活动结束时间")%>:</td>
  ...
  <tr>
    <td align="right"><%=r.getString(teasession._nLanguage, "活动省")%>: </td>
    <td>
   ...
   <tr>
    <td align="right"><%=r.getString(teasession._nLanguage, "活动市")%>: </td>
    <td>
   ...
   <tr>
    <td align="right"><%=r.getString(teasession._nLanguage, "活动详细地址")%>: </td>
    <td>
...
<tr>
 ...
 <tr>
  ...
  <tr>
    <td align="right"><%=r.getString(teasession._nLanguage, "举行活动夜店名称")%>:</td>
  ...
  <tr>
    <td align="right"><%=r.getString(teasession._nLanguage, "门票价格(活动预算)")%>: </td>
...
<tr>
    ...
    <tr>
    <td align="right"><%=r.getString(teasession._nLanguage, "活动评价")%>: </td>
    ...
    <tr>
    <td align="right"><%=r.getString(teasession._nLanguage, "活动关联组图")%>: </td>
  ...
  <tr>
    <td align="right"><%=r.getString(teasession._nLanguage, "活动关联组图主题")%>: </td>
  ...
  <tr>
    <td align="right"><%=r.getString(teasession._nLanguage, "活动关联组图内容")%>: </td>
    ...
    <input  id=CHECKBOX type="CHECKBOX" name="album_text_4"   <%=getCheck(ld.getAnchor("album_text"))%>><%=r.getString(teasession._nLanguage, "Anchor")%>&nbsp;</td>
      ...
      <tr><td colspan="2"><hr size="1"></td></tr>
  <tr>
    <td align="right"><%=r.getString(teasession._nLanguage, "活动要求")%>:</td>
