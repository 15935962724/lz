...
<%
	...
	int tkid = 0;
	if (teasession.getParameter("tkid") != null
			&& teasession.getParameter("tkid").length() > 0) {
...
<div id="head6"><img height="6" src="about:blank" alt=""></div>
   ...
   <input type='hidden' name='act' value="EditTalkback">
...
<table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
	...
	<tr>
		...
		<td><%=Node.find(obj.getNode()).getSubject(teasession._nLanguage) %></td>
	</tr>
	<tr>
      ...
      <%if("audit".equals(teasession.getParameter("act"))){ %>
       <tr>
        ...
        <td><select name="hidden">
        	...
        	<option value="1" <%if(obj.getHidden()==1)out.print(" selected "); %>>-审核通过-</option>
        	<option value="2" <%if(obj.getHidden()==2)out.print(" selected "); %>>-拒绝评论-</option>
