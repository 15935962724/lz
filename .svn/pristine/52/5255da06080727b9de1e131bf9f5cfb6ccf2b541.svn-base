...
<body>
<h1>邀请——<%=n.getSubject(h.language)%></h1>
...
}else
{
  ...
  <tr onMouseOver="bgColor='#FFFFCA'" onMouseOut="bgColor=''">
    ...
    <td member="<%=member%>" username="<%=mid%>">
      <a href="###" onclick="mt.act(this,'email')">邀请(E-Mail)</a>
      <a href="###" onclick="mt.act(this,'sms')">邀请(短信)</a>
    </td>
  </tr>
  <%}
%>
...
<td colspan="20">
  ...
  <input type="button" name="multi" value="邀请(E-Mail)" onClick="mt.act(this,'email')"/>
  <input type="button" name="multi" value="邀请(短信)" onClick="mt.act(this,'sms')"/>
  <input type="button" value="邀请所有会员" onClick="mt.act(this,'all')"/>
</td>
<%
}%>
</table>
