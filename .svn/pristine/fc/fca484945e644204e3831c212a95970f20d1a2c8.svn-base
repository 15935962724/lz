...
<td>作品名称：
  ...
  <input type="text" name="trade2" value=""/></td>
<td>著作权人名称：
...
<table cellpadding="0" cellspacing="0" bordercolor="0" id="tablecenter">
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td>韩寒</td>
    <td>韩寒</td>
    <td><input name="button5" type=button value="查看详细" onClick="window.open('/jsp/cpcc/turnaccept/ArticalTeach_1.jsp', '_blank','width=750,height=600,scrollbars=yes');"><input type="button" value="编辑" onClick="window.open('/jsp/cpcc/turnaccept/ArticalTeach_Edit.jsp','_self')"><input type="button" value="删除"></td>
  </tr>
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    <td>032562367</td>
	<td>梦里花落知多少</td>
...
<div><input type="button" name="adds" value="添加" onClick="window.open('/jsp/cpcc/turnaccept/ArticalTeach_Add.jsp','_self')"><input type="button" name="leadins" value="导入" onClick="window.open('/jsp/cpcc/turnaccept/ArticaInfo_leadin.jsp','_self')"></div>
<div id="head6"><img height="6" src="about:blank"></div>
