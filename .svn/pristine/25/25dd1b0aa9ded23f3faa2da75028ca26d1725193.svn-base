...
<tr>
  ...
  <input type="hidden" value="" name="timeStartSmall"/>
      ...
      <td rowspan="4">
            ...
            <tr align="center" bgcolor="#97987F">
                <td colspan="7"><a href="#"  onclick="setDate(-1);" style="font-size:9pt;color:#282828;text-decoration: none; " >&lt;&lt; &lt;</A>
                :
                <%=getMonth(Integer.parseInt(SMONTH))%>
                &nbsp;
                <%=SYEAR%>
                :
                <a href="#" onClick="setDate(1);" style="font-size:9pt;color:#282828;text-decoration: none; ">&gt; &gt;&gt;</A></td>
            </tr>
            <tr bgcolor="#4A494A">
                <td>Sun</td>
  ...
  <tr><%java.util.Calendar calendar234 = java.util.Calendar.getInstance();
...
}else if(MONTH==2)
{
    ...
    <tr>
      ...
      <td><select name="sort"  style="color:#635531">
        <option value="">请选择</option>
        <option>品牌推广</option>
        <option>特别主题</option>
    ...
    <tr>
      ...
      <td><input name="Having" type="text"  style="color:#635531"></td>
    </tr>
    <tr>
      <td> </td>
      <td><input type="image" src="/tea/image/section/11080.jpg" name="Submit" value="Submit"></td>
      </tr>
    <input type="hidden" name="Context" value="ON"/>
    </form>
</table>
</body>
