...
<table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
  ...
  <td align="center"><%=index %></td>
    ...
    <td align="center" nowrap>
      <input type=button value="<%=r.getString(teasession._nLanguage,"批准")%>"  onClick="auditing('1','<%=said%>');">
      <input type=button value="<%=r.getString(teasession._nLanguage,"不批准")%>"  onClick="auditing('-1','<%=said%>');">
    </td>
  </tr>
<%
index++;
