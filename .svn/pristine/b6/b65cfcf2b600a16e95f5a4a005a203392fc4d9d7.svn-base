...
function f_sub(igd)
{
	...
	if(form1.file.value=="")
	{
	 ...
	 ymPrompt.win({message:'<br><center>正在初始化会员信息,请稍候...</center>',title:'',width:'300',height:'50',titleBar:false});
...
<FORM NAME="form1" target="CR_ImportPreview" ACTION="/jsp/westrac/WestracMemberImportsData.jsp" enctype="multipart/form-data" METHOD="post" >
...
<table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
  <TR>
    ...
    <input type="button" name="Download" value="下载模板" onclick="window.open('/jsp/westrac/westracTemplate.xls','CR_ImportPreview');">
