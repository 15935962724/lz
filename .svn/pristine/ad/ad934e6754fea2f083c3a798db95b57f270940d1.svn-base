...
<table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''" title="点击选择商品"  onclick="f_button('<%=node.getSubject(teasession._nLanguage)%>');"  style=cursor:pointer>
