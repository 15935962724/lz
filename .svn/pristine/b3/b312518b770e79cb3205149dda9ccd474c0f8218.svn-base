...
<table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
  ...
  <td><input type="TEXT" class="edit_input"  name=index VALUE="<%=s8%>" SIZE=20 MAXLENGTH=20></td-->
    ...
    <tr>
      ...
      <td><input type="TEXT" class="edit_input"  name=Author VALUE="<%=s2%>" SIZE=30 MAXLENGTH=20></td>
    </tr>
    <tr>
      <td><%=r.getString(teasession._nLanguage, "Address")%>:</td>
      <td><input type="TEXT" class="edit_input"  name=Address VALUE="<%=s5%>" SIZE=30 MAXLENGTH=20></td>
    </tr>
    <tr>
      <td><%=r.getString(teasession._nLanguage, "save")%>:</td>
      <td><input type="TEXT" class="edit_input"  name=Save VALUE="<%=s7%>" SIZE=30 MAXLENGTH=20></td>

    </tr>
    <tr>
      <td><%=r.getString(teasession._nLanguage, "价格")%>:</td>
      <td><input type="TEXT" class="edit_input"  name=price VALUE="<%=price%>" SIZE=30 MAXLENGTH=20  onblur="this.value=this.value.replace(/\D/g,'');" onKeyPress="if(event.keyCode<48||event.keyCode>57)event.returnValue=false;" ></td>
    </tr>
    <tr>
      <td><%=r.getString(teasession._nLanguage, "图片类型")%>:</td>
      <td><select name="pictype"><option value="0">------</option><option value="1" selected="selected">免税版</option><option value="2">收税版</option></select></td>
    </tr>
    <tr>
