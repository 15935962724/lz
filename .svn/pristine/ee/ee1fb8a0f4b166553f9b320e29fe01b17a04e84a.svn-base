...
out.print(enumerationLocId.nextElement()+" ");}%></Span></span></div></td>
  ...
  <tr>
    ...
    <td><div align="left"><span><Span ID=JobIDtext><%=node.getText(teasession._nLanguage)%></Span></span></div></td>
  </tr>
</table>
  <div align="center">
    <input name="Submit" class="in" type="submit" onClick="javascript:history.back();" value="返回">
  </div>
</div></div>
<div align="center">
