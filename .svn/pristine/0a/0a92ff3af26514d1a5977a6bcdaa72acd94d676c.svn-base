...
<table cellpadding="0" cellspacing="0" bordercolor="0" id="tablecenter">
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td><input name="button53" type=button value="查看详细" onClick="window.open('/jsp/cpcc/turnaccept/AuthorInfo_1.jsp', '_blank','width=750,height=600,scrollbars=yes');">
    ...
    <td><input name="button5" type=button value="查看详细" onClick="window.open('/jsp/cpcc/turnaccept/AuthorInfo_1.jsp', '_blank','width=750,height=600,scrollbars=yes');">
      <input type="button" value="删除"></td>
  </tr>
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
      <td><input type="checkbox" name="checkbox310" value="checkbox"></td>
    ...
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
      <td><input type="checkbox" name="checkbox311" value="checkbox"></td>
    ...
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
      <td><input type="checkbox" name="checkbox312" value="checkbox"></td>
    ...
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
      <td><input type="checkbox" name="checkbox313" value="checkbox"></td>
    ...
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
      <td><input type="checkbox" name="checkbox314" value="checkbox"></td>
    ...
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
      <td><input type="checkbox" name="checkbox315" value="checkbox"></td>
    <td>569852367</td>
	<td>张艺谋</td>
    <td>01065898525</td>
    <td>986789658541236598</td>
  ...
  <tr>
    <td colspan="6"><input type="checkbox" name="checkbox4" value="checkbox">
      全选</td>
  </tr>
</table>
...
<div style="text-align:center"><input type="button" value="选中的用户通过审核"></div>
<div id="head6"><img height="6" src="about:blank"></div>
