...
Album a=Album.find(h.getInt("node"));

Node n=Node.find(a.node);
...
<tr><td rowspan="2" class="left"><img src="<%=n.getPicture(h.language)%>"/>
</td>
<td>
<%=n.getSubject(h.language)%>
</td></tr>
<tr><td><a href="javascript:f_view()">重新播放</a></td></tr>
</table>
<table cellpadding="0" cellspacing="4" class="ThemList">
<tr><td style="border:0px;">大家都在看</td></tr>
<tr>
<%
Enumeration e=Node.find(" AND father="+n.getFather()+" AND node!="+a.node+" AND hidden=0 ORDER BY click DESC",0,3);
...
while(e.hasMoreElements())
{
  ...
  out.print("<td style=text-align:center;><a href='/xhtml/album/"+nid+"-"+h.language+".htm' target='_parent'><img style=border:0px; src='"+n.getPicture(h.language)+"' /><br/>"+n.getSubject(h.language)+"</a></td>");
}
%>
</tr></table>
</body>
