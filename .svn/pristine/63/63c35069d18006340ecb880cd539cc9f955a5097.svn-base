...
if(atn==null||atn.indexOf("0006")==-1)
{
...
<input type=hidden name=trade_no value="<%=Annuity.encode("0006")%>">
...
<table border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
  <tr>
    ...
    <td><span style="float:left;margin-left:10px;"><%=Annuity.Annuity_0007(session,corp_no,_strPlan_code)%></span></td>
  </tr>
  <tr>
    ...
    <td>
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td style="width:180px;"><input class="biaodan" type="text" name="startdate" value="<%=_strStartdate!=null?_strStartdate:(c.get(c.YEAR)+"-"+(c.get(c.MONTH)+1)+"-1")%>" /><a href=### onclick="showCalendar('form1.startdate');"><img src="/res/eacebbank/u/0704/070425969.jpg"/></a></td>
          <td class="xiaobiao"><%=r.getString(teasession._nLanguage,"1186542560843")%>：</td>
          <td><input class="biaodan" type="text" name="enddate"  value="<%=_strEnddate!=null?_strEnddate:(c.get(c.YEAR)+"-"+(c.get(c.MONTH)+1)+"-"+c.get(c.DAY_OF_MONTH))%>" /><a href=### onclick="showCalendar('form1.enddate');"><img src="/res/eacebbank/u/0704/070425969.jpg"/></a></td>
        </tr>
      </table>
</td>
  </tr>
