...
var loadingImage = '/tea/image/loading.gif';		
var closeButton = '/tea/image/close.gif';		

var lan = location.href;
var Prompted='点击 <kbd>x</kbd> 关闭';
if(lan.indexOf("language=0")!=-1 || lan.indexOf("-0.htm")!=-1)
{
	//说明是中文
	Prompted='press <kbd>x</kbd> to close';
}
...
function initLightbox()
{
	...
	imgPreloadCloseButton.onload=function(){
		...
		objCloseButton.style.filter="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/tea/image/close.png', sizingmethod=scale);" 
	...
	objKeyboardMsg.innerHTML =Prompted; //'press <kbd>x</kbd> to close';
