     ...
     <tr id="tableonetr">
       ...
       <%
        	...
        	while(en.hasMoreElements()){
        		...
        		AdminUsrRole adobj = AdminUsrRole.find(teasession._strCommunity,obj.getMember());
        		AdminUnit auobj = AdminUnit.find(adobj.getUnit());//得到的用户的部门名字
        		
        		 tea.entity.member.Profile pf_obj=tea.entity.member.Profile.find(obj.getMember());//得到的用户的姓名
        		 if(unit==adobj.getUnit()){
        ...
        <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
        	...
        	<%
        	 ...
        	 %>
        	 <td nowrap><a href="/jsp/admin/manage/edit.jsp?time2=<%=time2%>&arrclass=<%=arrclass %>&unit=<%=unit %>&id=<%=id %>">修改</a></td>
        </tr>
        <%
        	}
        	}
...
<br><center><input type="button" class="BigButton" value="返回" onClick="location='/jsp/admin/manage/search2.jsp?time_d=<%=time2 %>';"></center><br>
</body>
</html>
