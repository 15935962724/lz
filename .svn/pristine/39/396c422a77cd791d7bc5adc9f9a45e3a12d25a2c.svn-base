...
public class Professional extends Entity
{
    ...
    public static int create(int node, int language, Date begda, Date endda, String zzglb, int zrzjb, String zzgdm, String zfzdw, Date zqzsj, String zzsbh, String zjddw, String zqtbz, String zqdzgtj) throws SQLException
    {
        DbAdapter db = new DbAdapter();
        int i =0;
        try
        {
           i= db.executeUpdate("INSERT INTO Professional(node,language,begda,endda,zzglb,zrzjb,zzgdm,zfzdw,zqzsj,zzsbh,zjddw,zqtbz,zqdzgtj)VALUES(" +
                                    node + "," + language + "," + db.cite(begda) + "," + db.cite(endda) + "," + DbAdapter.cite(zzglb) + "," + (zrzjb) + "," + DbAdapter.cite(zzgdm) + "," + DbAdapter.cite(zfzdw) + "," + db.cite(zqzsj) + "," + DbAdapter.cite(zzsbh) + "," + DbAdapter.cite(zjddw) + "," + DbAdapter.cite(zqtbz) + "," + DbAdapter.cite(zqdzgtj) + ")");
	} finally
        {
            db.close();
        }
//        _cache.remove(new Integer(professional));
    ...
    public void set(Date begda, Date endda, String zzglb, int zrzjb, String zzgdm, String zfzdw, Date zqzsj, String zzsbh, String zjddw, String zqtbz, String zqdzgtj) throws SQLException
    {
        ...
        try
        {
            db.executeUpdate("UPDATE  Professional SET begda=" + db.cite(begda) + ",endda=" + db.cite(endda) + ",zzglb=" + DbAdapter.cite(zzglb) + ",zrzjb=" + zrzjb + ",zzgdm=" + DbAdapter.cite(zzgdm) + ",zfzdw=" + DbAdapter.cite(zfzdw) + ",zqzsj=" + db.cite(zqzsj) + ",zzsbh=" + DbAdapter.cite(zzsbh) + ",zjddw=" + DbAdapter.cite(zjddw) + ",zqtbz=" +
    ...
    public static int count(int node, int language) throws SQLException
          {
            ...
            try
            {
              db.executeQuery("SELECT COUNT(*) FROM Professional WHERE node=" + node + " AND language=" + language);
              while (db.next())
              {
                i = db.getInt(1);
              }
    ...
    public String getZqzsjToString()
    {
        if(zqzsj==null)
            return "";
        return sdf.format(zqzsj);
    }
