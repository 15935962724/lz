...
<FORM NAME="form1" target="CR_ImportPreview" ACTION="/jsp/copyright/CrImportPreview.jsp" enctype="multipart/form-data" METHOD="post" onSubmit="return submitText(this.file,'无效-文件');">
...
<h2>导入预览</h2>
<iframe src="/jsp/copyright/CrImportPreview.jsp?act=<%=act%>" name="CR_ImportPreview" width=90% height=400px frameborder="1" ></iframe>
