...
<div class="Or">
<!--<table id="or" cellpadding="0" cellspacing="0">
  <tr>
    <td>商品总金额：</td>
    <td class="b2">￥<%=o.getTotalMoney() %>元</td>
  </tr>
  <tr>
    <td>订单总金额（包含运费）：</td>
    <td class="b1"><%=o.getStatus()==1?"计算运费中...":"￥"+o.getTotalMoney().add(o.getFreight())+"元" %></td>
  </tr>
</table>-->

	<p><span class="span1">商品总金额：</span><span class="b2">￥<%=o.getTotalMoney() %>元</span></p>
	<p><span class="span1">订单总金额（包含运费）：</span><%=o.getStatus()==1?"<span class='b1'>计算运费中...</span>":"<font color='red'>￥"+o.getTotalMoney().add(o.getFreight())+"元</font>" %></p>
</div>
<%
	}
%>
