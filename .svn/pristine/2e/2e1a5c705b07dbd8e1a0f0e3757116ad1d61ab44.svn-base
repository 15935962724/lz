...
<table border="0" cellpadding="0" cellspacing="0" class="regtable">
  ...
  <tr>
    ...
    <td style="width:272px !important"><input class="in text1" name="member" onfocus="v_mobile(this)" onblur="v_mobile(this)" min='4' size="21" maxlength="20" alt="手机号码"><span id="member_info"></span></td>
  </tr>
  <tr>
    <td align="right" class="td01" valign="top"><span>*</span>请设置密码：</td>
    <td><input class="in text3" type="password" name="password" onfocus="mt.f_p(this)" onblur="mt.f_p(this)" min='6' size="21" maxlength="20" alt="密码"><span id="password_info"></span></td>
  </tr>
  <tr>
