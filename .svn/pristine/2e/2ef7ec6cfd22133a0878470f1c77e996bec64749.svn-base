...
<table id="tablecenter" cellspacing="0">
  ...
  <tr>
    <td>显示位置</td>
    <td><span id="showtype0"><input type="radio" name="showtype" value="0" onclick="reLogo()" <%=sd.showtype==0?"checked":"" %>>类别</span><span id="showtype1"><input type="radio" value="1" id="showtype1" name="showtype" onclick="reLogo()" <%=sd.showtype==1?"checked":"" %>>商品</span></td> 
  </tr>
  <tr id="logoTr">
    <td>分类详情logo</td>
