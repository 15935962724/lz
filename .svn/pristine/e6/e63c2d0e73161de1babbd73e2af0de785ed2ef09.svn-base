...
try {
	...
	while (rs.next()) {
		...
		String href = "/xhtml/papc/folder/13113601-1.htm?reserve="+reserve+"&irstlevel="+MT.f(firstlevel)+"&secondlevel="+MT.f(secondlevel)+"&species1="+MT.f(species1BySql)+"&rname="+MT.f(rname)+"&cperson="+MT.f(cperson)+"&csite="+MT.f(csite)+"&unit="+h.enc(unit);
