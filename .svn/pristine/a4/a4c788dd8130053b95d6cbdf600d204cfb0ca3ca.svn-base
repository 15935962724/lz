...
{
  tea.entity.admin.SubsidyMenu af_obj=tea.entity.admin.SubsidyMenu.find(strid);
  ...
  int sequence=Integer.parseInt(request.getParameter("sequence"));
   ...
   {
     case 1://添加兄弟
     tea.entity.admin.SubsidyMenu.create(name,type,sequence,af_obj.getFather(),node.getCommunity(),teasession._nLanguage);
     break;
     case 2://添加子
     tea.entity.admin.SubsidyMenu.create(name,type,sequence,strid,node.getCommunity(),teasession._nLanguage);
     break;
     case 3://修改
     ...
     break;
     case 5://复制
     tea.entity.admin.SubsidyMenu.clone(strid,Integer.parseInt(teasession.getParameter("clone")),node.getCommunity(),teasession.getParameter("sonclone")!=null);
   }
  response.sendRedirect(request.getRequestURI()+"?node="+teasession._nNode+"&id="+strid);
  return;
}
int root=SubsidyMenu.getRootId(teasession._strCommunity);
...
<body>
<h1><%=r.getString(teasession._nLanguage, "津贴单位管理")%></h1>
<div id="head6"><img height="6" alt=""></div>


<form id="fun" name="fun" action="/jsp/admin/schoolfinance/EditSubsidyMenu.jsp" method="POST">
  ...
  <table border="0" cellPadding="0" cellSpacing="0"  id="tablecenter">
    ...
    <tr>
      ...
      <td  >
        <input name="name" type="text" id="name"  o value="<%=name%>" size="35"></td>
    </tr>
    <tr>
