...
for(int index=1;enumer.hasMoreElements();index++)
{
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td><input type=button value=调看 onclick="window.open('/jsp/copyright/Crbargain1View.jsp?community=<%=teasession._strCommunity%>&crbargain=<%=id%>','','height=500,width=700,status=no,toolbar=no,menubar=no,location=no');" >
       <input type=button value=编辑 onclick="window.open('/jsp/copyright/EditCrbargain1.jsp?community=<%=teasession._strCommunity%>&crbargain=<%=id%>&nexturl='+encodeURIComponent(location),'_self');" >
...
<input type=button value=添加 onclick="window.open('/jsp/copyright/EditCrbargain1.jsp?community=<%=teasession._strCommunity%>&crbargain=0&nexturl='+encodeURIComponent(location),'_self');" >
