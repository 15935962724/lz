...
function check(){
return submitText(Form1.tbSchoolName,'<%=r.getString(teasession._nLanguage,"1167472331375")%>')
&&submitSelect(Form1.ddlMajorCategory,'<%=r.getString(teasession._nLanguage,"1167472360500")%>')
&&submitText(Form1.tbMajorName,'<%=r.getString(teasession._nLanguage,"1167472380640")%>');
}
...
function f_add()
{
  Form1.nexturl.value="/jsp/type/resume/EditEducate2.jsp?nexturl=/jsp/type/resume/EditResume2.jsp&node="+Form1.node.value;
  Form1.action='/servlet/EditEducate';
  if(check()){
    Form1.submit();
  }
}
function f_add2()
{
   Form1.nexturl.value="/jsp/type/resume/EditResume2.jsp?node="+Form1.node.value;
...
<form name="Form1" method="post" action="/servlet/EditEducate"  onsubmit="return check();" id="Form1">
...
--%>
              <tr>
                <td align="right" valign="baseline"><span class="alert"><strong>*</strong></span>
                  <strong><%=r.getString(teasession._nLanguage,"1167471334046")%><!--专业类别--></strong>
                </td>
	...
	<tr>
		<td><div align="center"><br>
                ...
                <input   type="button" name="btnSave" value="<%=r.getString(teasession._nLanguage,"保存")%>" onclick="f_add2();"  />
                  <input   type="button" name="btnSave" value="<%=r.getString(teasession._nLanguage,"1167472179203")%>" onclick="f_add();"   />
