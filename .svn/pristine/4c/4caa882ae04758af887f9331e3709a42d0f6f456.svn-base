<%@page import="tea.entity.node.SPicture"%>
...
ArrayList list = SPicture.find(" AND specimen=" + h.node,0,200);
int size=list.size();
for(int i=0;i<size;i++)
{
    SPicture t = (SPicture) list.get(i);
    %>
	<li><img src="/res/attch<%=t.mulname.replaceFirst("TestData","170").replaceFirst("Multimedia","-") %>" alt=""></li>
	<%
}
