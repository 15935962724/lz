...
sql.append(" AND microid=0 AND stime IS NOT NULL");
...
<tr id="tableonetr">
  ...
  <td>标题</td>
<!--  <td>内容</td>-->
  <td><a href="javascript:mt.order(1)" id="O1">发生时间</a></td>
  <td nowrap>上传人</td>
  <td nowrap><a href="javascript:mt.order(0)" id="O0">上传时间</a></td>
  <td nowrap>分享人</td>
  <td nowrap><a href="javascript:mt.order(2)" id="O2">分享时间</a></td>
  <td>操作</td>
</tr>
<%
if(sum<1)
...
<tr>
  <td colspan="2"><input type="checkbox" onclick="mt.select(form2.nodes,checked)" id="sel"/><label for="sel">全选</label>
    <input type="button" name="multi" value="删除" onclick="mt.act('del',0)"/></td>
