...
<body id="bodynone">
 <h1>职位类别管理</h1>
  ...
  <form action="/jsp/type/lvyou/JobCatagory.jsp" name="form1" method="POST">
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
    ...
    <%
        ArrayList<LvyouJobCatagory> models = LvyouJobCatagory.find();
        for(int i=0;i<models.size();i++)
       {
        	  model=(LvyouJobCatagory)models.get(i);
        	  
    %>
     <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
         <td><b><%=model.getName()%></b></td>
         <td><a href="/jsp/type/lvyou/JobCatagory.jsp?id=<%=model.getId()%>">编辑</a>&nbsp;
