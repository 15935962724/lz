...
<table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
	<tr id="tableonetr">
      ...
      <td nowrap align="center">部门审批人</td>
    ...
    <%
    	...
    	java.util.Enumeration apme = Applys.findByCommunity(teasession._strCommunity," and type=1 and attemper ='"+teasession._rv+"'  "+sql+"");
  ...
  <%
   ...
   %>
      <td nowrap align="center"><%=pf_objs.getLastName(1)+pf_objs.getFirstName(1) %></td>
        ...
        <a href="/jsp/admin/vehicle/usage_detail.jsp?apid=<%=apid %>"  target="_blank">详细信息</a>&nbsp;
      	<a href="#");">预约情况</a><br>  
      	  ...
      	  <%
      	  		if(us.equals("0")){
      	   %>
      	<a href="/jsp/admin/vehicle/deal.jsp?apid=<%=apid %>&USES=1"> 批准</a>&nbsp;
      	 <a href="/jsp/admin/vehicle/deal.jsp?apid=<%=apid %>&USES=-1"> 不批准</a>&nbsp;
      	 <%
      	 		}if(us.equals("1")){
      	  %>
      	  		<a href="/jsp/admin/vehicle/deal.jsp?apid=<%=apid %>&USES=0"> 撤销</a>&nbsp;
      	  <%
      	  		}if(us.equals("-1")){
      	   %>
      	   		<a href="/jsp/admin/vehicle/deal.jsp?apid=<%=apid %>&USES=1"> 批准</a>&nbsp;
      	  <%
      	  		...
      	  		{
      	   %>
      	   <a href="/jsp/admin/vehicle/deal.jsp?apid=<%=apid %>&USES=2">收回</a>&nbsp;
      	   <%
      	   		}
      	    %>
      	<a href="/jsp/admin/vehicle/apply1.jsp?apid=<%=apid %>">修改</a>&nbsp;
     	 <a href="/jsp/admin/vehicle/deal.jsp?apid=<%=apid %>&DELETE=DELETE">删除</a>  
      </td>
    </tr>
