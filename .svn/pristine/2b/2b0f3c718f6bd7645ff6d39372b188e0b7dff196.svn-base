...
//
NightShop nightShop=new NightShop(teasession._nNode,teasession._nLanguage);
%>
<style type="text/css">
<!--
.g1 {
...
<td width="25%" align="right">身心放松度</td>
<td><div style="width:" <%=     nightShop.getRelaxMark()%> "%" class="g1" ></div>
									  </td>  </tr>
									  <tr bgcolor="#E9EAD1">    <td align="right">环境气氛</td>    <td><div style="width:<%= nightShop.getAuraMark()%>%" class="g1" ></div></td>    <td align="right">灯光</td>    <td><div style="width:" <%= nightShop.getLamplightMark()%>
                                      ...
                                      <%= nightShop.getMusicMark()%>%" class="g1" ></div></td>    <td align="right">空气清新度</td>    <td><div style="width:<%= nightShop.getAirMark()%>%" class="g1" ></div></td>  </tr>  <tr bgcolor="#E9EAD1">    <td align="right">人群素质</td>    <td><div style="width:<%= nightShop.getCrowdMark()%>
                                      ...
                                      "%" class="g1" ></div></td>    <td align="right">美女含量</td>    <td><div style="width:<%= nightShop.getBelleMark()%>%" class="g1" ></div></td>  </tr>  <tr bgcolor="#E9EAD1">    <td align="right">食品</td>    <td><div style="width:<%= nightShop.getDeliMark()%>%" class="g1" ></div></td>    <td align="right">价格</td>    <td><div style="width:<%=
