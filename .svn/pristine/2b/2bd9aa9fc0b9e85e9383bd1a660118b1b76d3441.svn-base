...
try {
	...
	while (rs.next()) {
		...
		int n = rs.getInt(i++);
		String href="/xhtml/papc/category/13113861-1.htm?type="+types+"&order1="+f;
...
window.onload=function(){
	changSelect('<%=types %>','');
		...
		<div class="search1"><form name="form1" action="/xhtml/papc/category/13113866-1.htm" method="post" >
...
function changSelect(o,f){
	...
	$.ajax({
		type:'post',
		url:'/mobjsp/leo/jsp/animalLeo.jsp',
