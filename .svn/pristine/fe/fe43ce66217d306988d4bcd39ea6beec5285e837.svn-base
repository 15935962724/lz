...
<input type=hidden name="nexturl" value="<%=nexturl%>"/>
     ...
     <tr><td>项目计划号</td>
       ...
       <tr>
         <td>其它文件1</td>
         <td nowrap><input name="otheruri" onChange="fview(this);" type="file" size="40"  id="otheruri">
         <%
         ...
         %>
         <a id="a_otheruri" href="###" style="display:none" ><img id="img_otheruri" align=absmiddle onerror="if(this.src.indexOf('defaut.gif')==-1)this.src='/tea/image/other/defaut.gif';" src=""/><span id="span_otheruri"></span></a>
         </td>
       </tr>

	        <tr>
	          <td>其它文件2</td>
              <TD><input name="other2uri" onChange="fview(this);"  type="file" size="40"  id="other2uri">
                       <%
         ...
         %>
         <a id="a_other2uri" href="###" style="display:none" ><img id="img_other2uri" align=absmiddle onerror="if(this.src.indexOf('defaut.gif')==-1)this.src='/tea/image/other/defaut.gif';" src=""/><span id="span_other2uri"></span></a>
              </TD>
</tr>
       <tr>
         <td>&nbsp;</td>
