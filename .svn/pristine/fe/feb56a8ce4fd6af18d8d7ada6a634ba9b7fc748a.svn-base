  ...
  <tr id="tableonetr">
    ...
    <td nowrap><a href="javascript:f_order('member');">经办人</a>
     <%
          ...
          %></td>
    <td nowrap><a href="javascript:f_order('quantity');"><%if(flowtype==4){out.print("到货数量");}else if(flowtype==3){out.print("采购剩余数量");}else{out.print("采购数量");}%></a>
     <%
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td align="center"><%=qq%></td>
     ...
     if(flowtype==0)
     {
       ...
       {
         out.print("<font color=red>等待审核采购单</font>");
       }else if(pobj.getFlowtype()==1)
       {
         out.print("<font color=red>已审核未到货</font>");
       } else if(pobj.getFlowtype()==2)
       {
         out.print("<font color=red>部分商品未到货</font>");
       }
       ...
       {
         out.print("<font color=red>商品全部到货</font>");
       }
       out.print("</td>");
     }
     %>
    <%
        ...
        {
           out.print(" <td align=\"center\"><a href=\"#\"  onclick=\"f_edit('"+pur+"');\">审核入库</a>&nbsp;<a href=\"#\"  onclick=\"f_delete2('"+pur+"');\">删除</a></td> ");
...
if(flowtype==0)
{
  out.print("<input type=\"button\" value=\"添加采购单\" onclick=\"window.open('/jsp/erp/EditPurchase.jsp?flowtype="+flowtype+"&nexturl="+nexturl+"','_self');\">");
}
%>
