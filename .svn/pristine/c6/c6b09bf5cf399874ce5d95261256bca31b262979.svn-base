  ...
  %>
        <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
         ...
         <td nowrap><!-- 编辑和删除 -->
          ...
          <a href="/jsp/type/csvservice/EditCsvservice.jsp?csvservice=<%=csvservice %>">编辑</a>

          <a href="/jsp/type/csvservice/EditCsvservice.jsp?csvservice=<%=csvservice %>&delete=delete" onClick="return window.confirm('您确定要删除此内容吗？');">删除</a>
         </td>
 	</tr>
  <%
}
...
<input type="button" value="<%=r.getString(teasession._nLanguage,"添加")%>" onClick="location='/jsp/type/csvservice/EditCsvservice.jsp';">
