...
public class Md5beijing {
     ...
     * a String, following the Md5beijing (rfc1321) algorithm,
    ...
    public Md5beijing (String input, String enc) {
        byte bytes [] = null;
        try {
    ...
    public Md5beijing (String input) {
        this(input, "UTF8");
    }
    ...
    public Md5beijing (InputStream in) {
        this.stringp = false ;
        this.in      = in ;
        this.state   = new int[4] ;
        this.buffer  = new byte[64] ;
        ...
        public void hmac_Md5beijing ( String text , String key )         throws IOException {
                ...
                if ( key_len > 64 ) {
                        key1 = new Md5beijing( key ).getDigest() ;
                        key_len = 16 ;
                }
                ...
                Md5beijing Md5beijing = new Md5beijing( "" ) ;
                Md5beijing.update( k_ipad , 64 ) ;
                Md5beijing.update( text.getBytes() , text_len ) ;
                digest = Md5beijing.getDigest() ;

                Md5beijing Md5beijing1 = new Md5beijing( "" ) ;
                Md5beijing1.update( k_opad , 64 ) ;
                Md5beijing1.update( digest , 16 ) ;
                digest = Md5beijing1.getDigest() ;
        }
