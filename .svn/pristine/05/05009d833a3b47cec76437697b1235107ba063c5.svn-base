...
Iterator it=Smoke.find(" AND state=2 AND type=1 ORDER BY code DESC",0,6).iterator();
if(!it.hasNext())
{
...
<a href="/html/tobacco/folder/14050097-1.htm" class="a1">更多>></a>
</div>

<div class="imgbox">
<table id="tablecenter" cellspacing="0" onmouseover="">
<%
it=Smoke.find(" AND state=2 AND type=2 ORDER BY code DESC",0,8).iterator();
if(!it.hasNext())
{
  out.print("<tr><td colspan='10' align='center'>暂无记录!</td></tr>");
}else
...
<a href="/html/tobacco/folder/14050054-1.htm" class="a1">更多>></a>
</div>
<div class="videobox">
<table id="tablecenter" cellspacing="0">
<%
it=Smoke.find(" AND state=2 AND type=3 ORDER BY code DESC",0,8).iterator();
if(!it.hasNext())
{
  out.print("<tr><td colspan='10' align='center'>暂无记录!</td></tr>");
}else
...
<a href="/html/tobacco/folder/14050053-1.htm" class="a1">更多>></a>
</div>
<script>
