...
if(code==null||code.length()<1)
{
  ...
  code=co.issued+issuecode+"〔"+year+"〕"+SeqTable.getSeqNo("flowbusiness.sn")+"号";
}else if(code.indexOf(issuecode)==-1)
{
  code=co.issued+issuecode+code.substring(code.indexOf('〔'));
}
