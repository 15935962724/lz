...
try {
	...
	while (rs.next()) {
		...
		int n = rs.getInt(i++);
		String href="/html/papc/category/13113871-1.htm?family1="+f;
...
%>
		...
		<div class="search"><form name="form1" action="/html/papc/category/13113871-1.htm" method="post" onSubmit="return checkSub();">
