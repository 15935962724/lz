...
java.util.Vector vector=tea.entity.node.EntSearch.findEntItems(teasession);
java.util.Enumeration enumeration=vector.elements();//.findByNode(nodecode);
while(enumeration.hasMoreElements()){
    tea.entity.member.Resume summery=    tea.entity.member.Resume.find(enumeration.toString(),teasession._nLanguage);
%>
<TR CLASS="TblTrStyle"><TD><INPUT  id="CHECKBOX" type="CHECKBOX" NAME="chk_id" VALUE="14423069"></TD>
    <TD><A href="/jsp/type/resume/Preview.jsp?member=<%=summery.getMember()%>" TARGET="_BLANK"><%=summery.getMember()%></A></TD>
    <TD>信息及管理制度高级主管</TD>
    <TD>总裁助理</TD>
    <TD>北京</TD>
    <TD>2 年</TD>
...
-->
  ...
  <TR>
    <TD align="center" class="bottomstyle" height="20">&copy;  版权所有 </TD>
  </TR>
</TABLE>
