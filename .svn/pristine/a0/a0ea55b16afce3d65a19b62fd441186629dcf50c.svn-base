...
EDiaryEditor = {
	...
	initView: function (sParentID) {
		var _this = this;
		var _toolbarStr = "\
			<div id='EDiaryEditor'style='width: 550px;'>\
				...
				<div id='EDiaryEditorContent'>\
					<iframe id='editor_body_area' name='editor_body_area' style='width: 621px; height: 130px; border-width: 0px; overflow-x: atuo; display: nones;' ></iframe>\
					<textarea id='editor_body_textarea' name='editor_body' style='width: 548px; height: 200px;display: none;'></textarea>\
					<input type='hidden' name='char_count' value='-1' id='EDiaryEditorStrLen'>\
				</div>\
				<div >\
					<div id='ModeCheck'></div>\
				</div>\
			</div>\
		";
