...
<form action="" name="formss">
<input type="hidden" name="o" VALUE="<%=o%>">
<input type="hidden" name="aq" VALUE="<%=aq%>">
<input type="hidden" name="community" value="<%=teasession._strCommunity%>"/>


  <Div class="dianbt"><span id="dian1"><a href="javascript:f_order('regtime');">病例提交时间</a>
  <%
  if(o.equals("regtime"))
  {
    if(aq)
  ...
  %></span><span id="dian1"><a href="javascript:f_order('diannum');">点击率</a>
  <%
  if(o.equals("diannum"))
  {
    if(aq)
...
<%
Enumeration eu = CaseCollection.findByCommunity(teasession._strCommunity,sql.toString(),pos,5);
