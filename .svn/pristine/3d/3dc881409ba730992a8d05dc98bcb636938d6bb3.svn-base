...
function f_load()
{
  ...
  if(sel)
  {
    sel=window.showModalDialog('/jsp/admin/flow/SetFlowbusinessDocs.jsp?community=' + form1.community.value + '&field=dynamictype35&t='+new Date().getTime(),self,'dialogWidth:300px;dialogHeight:280px;help:0;status:0;scroll:0;');
...
if(flowbusiness>0)
{
  ...
  StringBuilder read1=new StringBuilder("<tr><td class='tdtitle'>已 办 理</td><td>");
