...
function f_sub(igd,strigd)
{
	  ...
	  if(submitCheckbox(form1.memberorder,strigd))
	  {
			...
			{
				var str = '<br><br><input type="radio" id="membertypeid" name="membertypeid" value="1">通过审核&nbsp;&nbsp;<input type="radio" id="membertypeid" name="membertypeid" value="3">审核不通过&nbsp;&nbsp;';
				//alert("s");
...
function f_v(igd)
{
	var str = '<br><br><input type="hidden" id="igd" name="igd" value='+igd+'><input type="radio" id="membertypeid" name="membertype" value="1">通过审核&nbsp;&nbsp;<input type="radio" id="membertypeid" name="membertype" value="3">审核不通过&nbsp;&nbsp;';
//alert("s");
...
%>
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
    ...
    <td><a href="/jsp/user/EditGolfMember.jsp?member=<%=member%>&nexturl=<%=nexturl %>"><%=pobj.getCode()%></a></td>
