...
mt.act=function(t,a,b)
{
  ...
  if(a=='del')
  {
    mt.show('你确定要删除吗？',2,"form2.action='/EditConsultant.do';form2.submit()");
  }else if(a=='reset')
  {
    mt.show('你确定要重置密码吗？',2,"form2.action='/EditConsultant.do';form2.submit()");
  }else if(a=='add')
  {
  ...
  {
    if(a=='view')
      form2.action='/jsp/type/Consultant/ConsultantInfo.jsp';
    else if(a=='edit')
      form2.action='/jsp/type/Consultant/EditConsultant.jsp';
