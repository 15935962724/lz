...
if(request.getMethod().equals("POST"))
{
  ...
  try
  {
    ...
    while(db.next())
    {
      ...
      System.out.println("价格批修:"+commodity+":"+currency+"\t折:"+discounts);
...
<table cellspacing="0" cellpadding="0" border="0" id="tablecenter">
  <tr>
    ...
    <td><input type="TEXT" name=discounts size=6 value="0.00" onKeyPress="inputFloat();">折</td>
  </tr>
  <tr>
...
<table cellspacing="0" cellpadding="0" border="0" id="tablecenter">
<tr><td>注:</td></tr>
<tr><td>1.请在"价格框"中直接输入折扣,如:打9折,请输入9</td></tr>
</table>
