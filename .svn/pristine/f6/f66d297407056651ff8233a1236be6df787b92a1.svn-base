...
{
  if (!node.isCreator(teasession._rv)&&!AccessMember.find(node._nNode, teasession._rv._strV).isProvider(53))
  {
...
function checkform(theform){
    ...
    <form action="/servlet/EditLFinancing" method="POST" name="foNew" onSubmit="return checkform(this);" >
    <%
    String parameter=teasession.getParameter("nexturl");
    boolean   parambool=(parameter!=null&&!parameter.equals("null"));
            LFinancing financing=LFinancing.find(0,teasession._nLanguage);
    if(parambool)
...
String subject="";
   Date issueDate=null;
        ...
        {subject=node.getSubject(teasession._nLanguage);
         financing=LFinancing.find(teasession._nNode,teasession._nLanguage);
 ...
 <table cellspacing="0" cellpadding="0" border="0" id="tablecenter">
      ...
      <tr>
        <td> <%=r.getString(teasession._nLanguage, Node.NODE_TYPE[30])%> </td>
      </tr><%--
           <tr>
...
<FONT color=#ff0000>(*)</FONT>
      ...
      <td><textarea  class="edit_input"  rows="8" cols="50"  name="synopsis" ><%=HtmlElement.htmlToText(financing.getSynopsis())%></textarea><FONT color=#ff0000>(*)</FONT></td>
    </tr>
    <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<FONT color=#ff0000>(*)</FONT>
    ...
    <tr>
	 ...
	 <tr>
      ...
      <td><input type="text"  class="edit_input"  name="mobile" value="<%=getNull(financing.getMobile())%>"></td>
    </tr>
	 <tr>
