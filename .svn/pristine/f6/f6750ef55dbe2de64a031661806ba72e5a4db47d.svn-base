...
<td><%=r.getString(teasession._nLanguage, "Time")%>:<input name="begin" readonly="readonly" type="text" size="9">
  <img onClick="td_calendar('formform111.begin');"  align="absmiddle" src="/tea/image/public/Calendar2.gif" style="cursor:hand;" >--
  <input name="end" readonly="readonly" type="text" size="9"><img onClick="td_calendar('form form111.end');" align="absmiddle" style="cursor:hand;"  src="/tea/image/public/Calendar2.gif">
...
<table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
  <TR id="tableonetr">
    ...
    <td><%=r.getString(teasession._nLanguage, "TheirBranch")%></td>
...
<tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''" >
    <td nowrap><%
            ...
            %></td>
    <td nowrap><A href="/jsp/type/dynamicvalue/DynamicValueView.jsp?node=<%=nodeobj._nNode%>" target="_blank"><%=nodeobj.getSubject(teasession._nLanguage)%></A></td>
    <td nowrap><%if(unit!=null)out.print(unit);%></td>
    ...
    <%
      ...
      <%}%>
<input type="button" value="<%=code.length()>0?r.getString(teasession._nLanguage,"CancelAuditing"):r.getString(teasession._nLanguage,"Auditing")%>" onClick="window.open('/jsp/type/dynamicvalue/EditCebbank.jsp?node=<%=nodeobj._nNode%>&community=<%=s%>', '_self');"/>
