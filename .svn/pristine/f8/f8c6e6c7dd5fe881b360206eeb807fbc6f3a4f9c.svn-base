 ...
 * 提交订单
 * */
public class CompressImg extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp)
        ...
        if("danzhang".equals(act)){
        	String img=h.get("img");
			...
			//String imgs=h.get("imgs");
    		//Filex.logs("ytimg.txt", "imgs:"+imgs);
    		//String[] img=imgs.split(",");
			Filex.logs("ytimg.txt", "长度==="+img.length);
			//String[] imgtype=req.getParameterValues("type");
			String savepath = "/res/Home/yl/";
			try {
				String name="";
