...
--%>
  ...
  <input type="button"   value="<%=r.getString(teasession._nLanguage,"保存")%>" onclick="f_add2();"  />
  <input type="button"    value="<%=r.getString(teasession._nLanguage,"1167530223796")%>" onclick="f_add();"/>
  <input type=button value="返回" onClick="javascript:window.location.href='/jsp/type/resume/EditResume2.jsp?node=<%=teasession._nNode%>';">
