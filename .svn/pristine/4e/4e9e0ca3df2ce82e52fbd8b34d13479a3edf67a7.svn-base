...
<form NAME="form1" target="CR_ImportPreview" ACTION="/jsp/admin/import/CrImportPreviewAdmin.jsp" enctype="multipart/form-data" METHOD="post" onSubmit="return submitText(this.file,'无效-文件');">
