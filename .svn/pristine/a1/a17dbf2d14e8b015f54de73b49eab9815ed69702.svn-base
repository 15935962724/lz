...
for(int index=1;enumer.hasMoreElements();index++)
{
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td><input type=button value=调看 onclick="window.open('/jsp/copyright/Crbargain0View.jsp?community=<%=teasession._strCommunity%>&crbargain=<%=id%>','','height=500,width=700,status=no,toolbar=no,menubar=no,location=no');" ></td>
 </tr>
<%
}
%>
