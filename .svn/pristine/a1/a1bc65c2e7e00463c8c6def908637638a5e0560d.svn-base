...
<FORM NAME="form1" target="CR_ImportPreview" ACTION="/jsp/type/women/ImportData.jsp" enctype="multipart/form-data" METHOD="post" onSubmit="return submitText(this.file,'无效-文件');">
