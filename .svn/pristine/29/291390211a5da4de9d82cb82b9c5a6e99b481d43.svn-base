...
AdminUsrRole aur=AdminUsrRole.find(teasession._strCommunity,pobj.getProfile());
out.print((aur.getRole().length()>1?"　<a href='/jsp/admin/indextop.jsp'>[后台管理]</a>":"　<a href='/html/folder/3-1.htm'>[个人中心]</a>")+"　<a href='###' class='fbtz' onclick=mt.show('/jsp/type/bbs/BBSEditSel.jsp?node="+teasession._nNode+"',1,innerHTML,300,400)>[发表贴子]</a>　<a href='/servlet/Logout?community="+teasession._strCommunity+"&nexturl=/'>[退出]</a>");
%>
