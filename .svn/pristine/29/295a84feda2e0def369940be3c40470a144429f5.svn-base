...
}else
{
  ...
  <tr onMouseOver="bgColor='#FFFFCA'" onMouseOut="bgColor=''">
    ...
    out.println("<a href=javascript:mt.act('manager',"+node+")>管理组图</a>");
    %>
  </tr>
  <%}
...
mt.act=function(a,id,b)
{
  ...
  }else
  {
    ...
    {
      form2.action='/mobjsp/type/reserve/EditReserve.jsp';
      form2.target=form2.method='';
    }else if(a=='manager'){
    	form2.action='/mobjsp/type/reserve/ManagerAlbum.jsp';
    }
    form2.submit();
  }
};
