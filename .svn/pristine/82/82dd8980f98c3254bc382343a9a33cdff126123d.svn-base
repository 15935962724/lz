...
//iwlk
InsertImagesLbl		: "批量插入",
InsertImages		: "批量插入图片",
InsertEmbedLbl		: "Embed",
InsertEmbed		: "插入/编辑 FLV视频",
InsertMediaLbl		: "Media",
InsertMedia		: "插入/编辑 视频",
//
InsertTableLbl		: "表格",
InsertTable			: "插入/编辑表格",
InsertLineLbl		: "水平线",
...
//iwlk
DlgImagesTitle		: "批量插入图片",
DlgEmbedTitle		: "FLV 属性",
DlgMediaTitle		: "视频 属性",
...
//iwlk
InvalidFileType     :"抱歉，不能上传此格式的文件",
SuccessfullyUploaded:"上传成功！",
TheFileIsTooLarge   :"抱歉，文件大小不能大于1M。"
