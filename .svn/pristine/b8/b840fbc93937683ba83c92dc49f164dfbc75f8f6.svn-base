...
<table border="0" cellpadding="0" cellspacing="0" style="display: <%= (mflag?"":"none")%>">
  <tr>
    <td align="right">手机：</td><td align="left"><input name="mob" alt="手机" /></td>
  </tr>
  <tr>
	<td align="right">手机验证码：</td><td align="left"><input name="verid" id="verid" alt="手机验证码"  />&nbsp;&nbsp;<input value="获取短信验证码" type="button" id="verbut" onclick="fsong()" /></td>	
    </tr>
    <tr>
    <td align="right">验证码：</td><td align="left"><input style="text-transform: uppercase; width:93px;" alt="验证码" onfocus="mt.verifys()" onchange="value=value.toUpperCase()" maxlength="4" name="verify" autocomplete="off" class="input" style='width:100px'>&nbsp;&nbsp;<a href="javascript:mt.verifys()"><img id="img_verifys" src="/Imgs.do?act=verify&amp;t=0.8841180045674784" alt="" style="visibility: visible;"></a>
			</td>
		</tr>
		<tr>
...
<table border="0" cellpadding="0" cellspacing="0" style="display: <%= (mflag?"none":"")%>">
  ...
  <tr>
	<td align="right" class="td01" nowrap="nowrap">验证码：</td><td><input style="text-transform: uppercase; width:93px;" alt="验证码" onfocus="mt.verifys1()" onchange="value=value.toUpperCase()" maxlength="4" name="verify1" autocomplete="off" class="input" style='width:100px'>&nbsp;&nbsp;<a href="javascript:mt.verifys1()"><img id="img_verifys1" src="/Imgs.do?act=verify&amp;t=0.8841180045674784" alt="" style="visibility: visible;"></a>
			</td>
		</tr>
    <tr>
  	<td colspan="2"><input type="submit" value="发送邮件" class="tijiao"></td>
  </tr>
</table>
