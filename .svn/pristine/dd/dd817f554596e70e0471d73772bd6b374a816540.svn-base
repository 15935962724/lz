...
<h1>分店预付款管理</h1>
<h2>查询</h2>
<form name="form3" action="/jsp/leagueshop/LeagueShopImprestListdaochu.jsp" method="get" >
...
for(int i=0;euls.hasMoreElements();i++)
{
  ...
  %>
    <tr>
      ...
      <td nowrap="nowrap"><input type="button" value="查询信息" onclick="window.open('/jsp/leagueshop/LeagueShopImprestList2.jsp?lsid=<%=lsid%>&num=0','_self')" />　
