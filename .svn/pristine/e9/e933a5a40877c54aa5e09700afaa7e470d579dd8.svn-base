<%@page contentType="text/html;charset=UTF-8" %><%@page import="tea.entity.node.*"%><%@page import="tea.entity.mzb.*"%><%@page import="java.io.*"%><%@page import="tea.entity.*"%><%@page import="java.util.regex.*"%><%@page import="java.awt.image.*"%><%@page import="java.awt.color.*"%><%@page import="java.util.*"%><%@page import="tea.entity.node.*"%><%@page import="tea.ui.*"%><%@page import="tea.db.*"%><%@page import="tea.entity.site.*"%><%@page import="tea.entity.member.*"%><%
...
if("POST".equals(request.getMethod()))
{
  ...
  E_News t=new E_News(teasession._strCommunity);
...
File dir=new File(application.getRealPath("/res/" + teasession._strCommunity + "/searchindex/e_news"));
