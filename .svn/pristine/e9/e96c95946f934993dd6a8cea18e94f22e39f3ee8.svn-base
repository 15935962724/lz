...
//      }
     ...
     <tr>
      ...
      <td colspan="4">
        ...
        {
           out.print("职务1："+Doctor.XINGZHENG_ZHICHENG[xingzhengzhicheng2]);
        }
    ...
    <tr>
      <td align="center" colspan="5">
        <input  id="printbutton"  type="button" value="关闭"  onClick="javascript:window.close();">
       &nbsp;&nbsp;&nbsp;&nbsp;
