...
<div id="head6"><img height="6" src="about:blank"></div>
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
      ...
      <th nowrap>*
         ...
         公司名称 :&nbsp;&nbsp;&nbsp;&nbsp;</th>
         <input type="hidden" class="edit_input"  name=MemberId value="申请的用户id" size=30 maxlength=40>
      <td ><a href="用户资料"></a>XXX公司</td>
      <td colspan="2"></td>
      </tr>
      <tr>
      <th nowrap>*
     ...
     <tr>
      <th nowrap>*
    资质证明文件:&nbsp;&nbsp;&nbsp;&nbsp;</th>
      <td ><a href="文件路径">用户上传的资质文件</a><span id="domain"></span></td>
      <td colspan="2"></td>
      </tr>
 <th nowrap>*
    批准意见:&nbsp;&nbsp;&nbsp;&nbsp;</th>
