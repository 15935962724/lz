...
<div style="text-align:center;margin-top:20px;margin-bottom:20px;font-size:18px;font-weight:bold;">作者详细资料</div>
...
<table border="0" cellpadding="0" cellspacing="1" id="tablecenterup">
	...
	<tr>
	  <td>创作范围</td>
	  <td colspan="3">文学评论</td>
	</tr>
	<tr>
	  <td>联系日期</td>
	  <td colspan="3">2004年2月2日</td>
	</tr>
	<tr>
	  <td>备注</td>
	  <td colspan="3">无</td>
...
<div style="text-align:center;margin-top:20px;"><input type="submit" name="Submit" value="打印">
</div>
  </form>
</div>
