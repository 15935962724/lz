...
<%
	...
	sql.append(" AND deleted = 0 AND type = 0 ");
	...
	<td>积分</td>
				...
				}else
				{
					...
					for(int i=0;i<shlist.size();i++){
						...
						out.print("<tr><td><a href='javascript:void(0);' onclick=ret('"+sh.profile+"','"+sh.member+"');>"+sh.member+"</a></td><td>"+Profile.MEMBER_TYPE[sh.membertype]+"</td><td>"+sh.getIntegral()+"</td></tr>");
					}
				}
