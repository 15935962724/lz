...
String serch=h.get("serch","");
String sql=" and (idCard like "+DbAdapter.cite("%"+serch+"%")+" or convertId like "+DbAdapter.cite("%"+serch+"%")+") and deleted=0";
ArrayList al=Taoism.find(sql,0,1);
Taoism t=new Taoism(0);
if(al.size()>0)
	t=(Taoism)al.get(0);
