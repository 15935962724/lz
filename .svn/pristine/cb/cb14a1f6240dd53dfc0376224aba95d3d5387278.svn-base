...
<td>1200.00</td>
<td><180</td>
<td><input type=button value=延期 onclick="if(confirm('确认延期? 免费延期15天.')){location.reload();}" ></td>
</tr>
...
<td>3200.00</td>
<td>>180 或 已经延期</td>
<td><input type=button value=延期 onclick="if(confirm('确认延期? 将收取10%的费用.')){location.reload();}" ></td>
</tr>
