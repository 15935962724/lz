...
{
  if(act=="ajax_opinion")dt="/141,142,143/";
...
function f_send()
{
  if(<%=isNew%>)
  {
    var dt581=form1.dynamictype581;
    var v=dt581.value;//正文
    if(v.indexOf(":")!=-1||dt581.defaultValue.indexOf(v)!=-1)
    {
...
{
  //f_swap(form1.base);
  var sel=form1.dynamictype581.value.indexOf(':')!=-1;
  if(sel)
  {
    sel=window.showModalDialog('/jsp/admin/flow/SetFlowbusinessDocs.jsp?community=' + form1.community.value + '&field=dynamictype581&t='+new Date().getTime(),self,'dialogWidth:360px;dialogHeight:280px;help:0;status:0;scroll:0;');
    form1.dynamictype581.value=sel;
  }
}
function f_stop()
{
...
if(bw||br)
{
  ...
  {
    out.print("window.open('/jsp/admin/flow/ViewDynamicOffice.jsp?community=" + teasession._strCommunity + "&flowview="+fv.getFlowview()+"&file='+f_split(previousSibling.value) );");
  }
  out.println("\" />");
  if(bw)out.print("<script>f_msgdoc=f_msgdoc2;</script>");
  if(authority)
  {
    out.println("<input type='button' value='盖章' onclick='form1.dynamictype_button581.onclick()' >");
  }
//  if(step==9)
//  {
...
out.println("<input type='button' value='下载' onclick=location.href='/servlet/EditFlowdynamicvalue?act=down&community='+form1.community.value+'&flowbusiness='+form1.flowbusiness.value+'&dynamictype=/581/157/' >");
...
if(dtw.indexOf("/141/")!=-1)
{
  out.println("<input type='button' value='填写意见' onclick=f_opinion('/141/142/143/') />");
}
//会签
if(dtw.indexOf("/146/")!=-1)
{
  out.println("<input type='button' value='填写意见' onclick='f_csign(146)' />");
}
...
//发文字号
if(dtw.indexOf("/158/")!=-1)//||isCreator
{
  out.println("<input type='button' value='文件字号' onclick='xny.code(158)' />");
}
//归档
...
<input type="text" name="dynamictype157" disabled="disabled" />
<input type="text" name="dynamictype141" disabled="disabled" />
<input type="text" name="dynamictype142" disabled="disabled" />
<input type="text" name="dynamictype143" disabled="disabled" />
<input type="text" name="dynamictype146" disabled="disabled" />
</div>
<!-- -end-->
...
<table id="tabbase"  <%if(ist.equals("1"))out.print("style='display:none'");%>>
  <tr>
    ...
    <td id="td153"><input type="text" name="dynamictype153" id="dynamictype153"/></td>
  </tr>
  <!--
  <tr>
    <td class="tdtitle">主 题 词</td>
    <td  id="td91"><table class="addbutton"><tr><td class="td1"><input type="text" name="dynamictype91" id="dynamictype91" /></td><td class="td2"><input type="button" value="提取" onClick="f_ajax('ajax_key','91',form1.dynamictype153.value);"/></td></tr></table></td>
  </tr>
  -->
  <tr>
    <td class="tdtitle">主　　送</td>
    <td  id="td154"><table class="addbutton"><tr><td class="td1"><input type="text" name="dynamictype154" id="dynamictype154"/></td><td class="td2"><input type="button" value="选择" onClick="f_dept(form1.dynamictype154);"/></td></tr></table></td>
  </tr>
  <tr>
    <td class="tdtitle">抄　　报</td>
    <td  id="td155"><table class="addbutton"><tr><td class="td1"><input type="text" name="dynamictype155" id="dynamictype155"/></td><td class="td2"><input type="button" value="选择" onClick="f_dept(form1.dynamictype155);"/></td></tr></table></td>
  </tr>
  <tr>
    <td class="tdtitle">抄　　送</td>
    <td  id="td156"><table class="addbutton"><tr><td class="td1"><input type="text" name="dynamictype156" id="dynamictype156"/></td><td class="td2"><input type="button" value="选择" onClick="f_dept(form1.dynamictype156);"/></td></tr></table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tdtitle" style="border-right:0px;">文件等级</td>
    <td style="padding:0px;border:0px;">
    <table id="tabbase_nei" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="tabtdteshu" id="td144"><input type="text" name="dynamictype144"  /></td>
        <td class="tdtitle">文件份数</td>
        <td id="td145"><input type='text' name='dynamictype145' /></td>
      </tr>
    </table>
    </td>
  </tr>
  <tr>
    <td class="tdtitle" style="border-right:0px;">审　　稿</td>
    <td style="padding:0px;border:0px;">
    <table id="tabbase_nei" border="0" cellspacing="0" cellpadding="0">
    <tr>
    <td  class="tabtdteshu" id="td150"><input type="text" name="dynamictype150" /></td>
    <td class="tdtitle">拟稿单位</td>
    <td id="td151"><input type="text" name="dynamictype151"/></td>
    </tr>
    </table>
    </td>
  </tr>
  <tr>
    ...
    <table id="tabbase_nei" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="tabtdteshu" id="td152"><input type="text" name="dynamictype152"  /><img src="/tea/image/public/blank_png.gif" style="display:none" oncontextmenu="return false"/></td>
        <td class="tdtitle">发文文号</td>
        <td id="td158"><input type="text" readonly="readonly" style="background:transparent;border:0;width:90%;" name="dynamictype158"/></td>
      </tr>
    </table>
    </td>
  </tr>
  <tr>
    <td class="tdtitle" style="border-right:0px;">打字</td>
    <td style="padding:0px;border:0px;">
    <table id="tabbase_nei" border="0" cellspacing="0" cellpadding="0">
    <tr class="out2">
    <td  class="tabtdteshu" id="td160"><input type="text" name="dynamictype160" /></td>
    <td class="tdtitle">成文时间</td>
    <td id="td159"><input type="text" name="dynamictype159" onclick='showCalendar(this,true)' readonly='true'  /></td>
    </tr>
    </table>
    </td>
  </tr>
  <tr>
    <td class="tdtitle" style="border-right:0px;">校对</td>
    <td style="padding:0px;border:0px;">
    <table id="tabbase_nei" border="0" cellspacing="0" cellpadding="0">
    <tr class="out2">
    <td  class="tabtdteshu" id="td161"><input type="text" name="dynamictype161" /></td>
    <td class="tdtitle">印发时间</td>
    <td id="td162"><input type="text" name="dynamictype162" onclick='showCalendar(this,true)' readonly='true'  /></td>
    </tr>
    </table>
    </td>
  </tr>
...
<img id="imgmap" src="/tea/flow/<%=flow==11?6:(flow==12?7:flow)%>.jpg" usemap="#Map" />
