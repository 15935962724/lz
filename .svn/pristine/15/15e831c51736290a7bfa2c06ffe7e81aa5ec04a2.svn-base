...
StringBuffer sql = new StringBuffer(" and n.type = 39 and r.cbutors=1  and n.audit!=4   ");
...
<style type="text/css">
body{margin:0;padding:0; #fff;font: 70% Arial, Helvetica, sans-serif;}
#scrlContainer{visibility:hidden;#fff;position:relative;overflow:hidden;width:100%;height:20px;line-height:20px;margin:1em;}
