...
<br>
<form action="/jsp/admin/workreport/ImportWorkproject3.jsp" METHOD=post enctype="multipart/form-data" name=form1 onSubmit="return submitText(this.file,'<%=r.getString(teasession._nLanguage,"InvalidFile")%>')">
  ...
  <input type="button" value="<%=r.getString(teasession._nLanguage,"上一步")%>" onClick="window.open('/jsp/admin/workreport/ImportWorkproject1.jsp?community=<%=teasession._strCommunity%>','_self');" >
