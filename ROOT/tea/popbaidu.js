...
if (typeof window.pageYOffset != 'undefined') {
   ...
   scrollPos = document.body.scrollTop;
       ...
       // alert("iTop is " + iTop);
        ...
        if(sleft<1)
           sleft="20";
		    var boxb=document.getElementById("dialogBox");
        oDialog['style']['left']="500px";
        oDialog['style']['top']= "200px";

//		alert(((document.body.offsetWidth-parseFloat(boxb.style.width))/2)+document.body.scrollLeft);
//		alert(((document.body.offsetHeight-parseFloat(boxb.style.height))/2)+document.body.scrollTop);
       ...
       // alert("document.documentElement.scrollTop+(document.documentElement.clientHeight)/10)" + document.documentElement.scrollTop+(document.documentElement.clientHeight)/10);
     // alert("document.documentElement.scrollTop+(document.documentElement.clientHeight)/10 " + document.documentElement.scrollTop+(document.documentElement.clientHeight)/10);
},
