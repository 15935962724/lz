var CITY=[];
CITY[0]=[[11,'BeiJingShi','北京市'],[12,'TianJinShi','天津市'],[13,'HeBeiSheng','河北省'],[14,'ShanXiSheng','山西省'],[15,'NeiMengGuZiZhiQu','内蒙古自治区'],[21,'LiaoNingSheng','辽宁省'],[22,'JiLinSheng','吉林省'],[23,'HeiLongJiangSheng','黑龙江省'],[31,'ShangHaiShi','上海市'],[32,'JiangSuSheng','江苏省'],[33,'ZheJiangSheng','浙江省'],[34,'AnHuiSheng','安徽省'],[35,'FuJianSheng','福建省'],[36,'JiangXiSheng','江西省'],[37,'ShanDongSheng','山东省'],[41,'HeNanSheng','河南省'],[42,'HuBeiSheng','湖北省'],[43,'HuNanSheng','湖南省'],[44,'GuangDongSheng','广东省'],[45,'GuangXiSheng','广西省'],[46,'HaiNanSheng','海南省'],[50,'ZhongQingShi','重庆市'],[51,'SiChuanSheng','四川省'],[52,'GuiZhouSheng','贵州省'],[53,'YunNanSheng','云南省'],[54,'XiCangSheng','西藏省'],[61,'ShanXiSheng','陕西省'],[62,'GanSuSheng','甘肃省'],[63,'QingHaiSheng','青海省'],[64,'NingXiaSheng','宁夏省'],[65,'XinJiangSheng','新疆省'],['71','TaiWanSheng','台湾省'],['81','XiangGangTeQu','香港特区'],['82','AoMenTeQu','澳门特区']];
...
CITY[1311]=[[131102,'TaoChengQu','桃城区'],[131121,'ZaoQiangXian','枣强县'],[131122,'WuYiXian','武邑县'],[131123,'WuQiangXian','武强县'],[131124,'RaoYangXian','饶阳县'],[131125,'AnPingXian','安平县'],[131126,'GuChengXian','故城县'],[131127,'JingXian','景县'],[131128,'FuChengXian','阜城县'],[131181,'JiZhouShi','冀州市'],[131182,'ShenZhouShi','深州市']];
...
CITY[2101]=[[210102,'HePingQu','和平区'],[210103,'ShenHeQu','沈河区'],[210104,'DaDongQu','大东区'],[210105,'HuangGuQu','皇姑区'],[210106,'TieXiQu','铁西区'],[210111,'SuJiaTunQu','苏家屯区'],[210112,'DongLingQu','东陵区'],[210113,'XinChengZiQu','新城子区'],[210114,'YuHongQu','于洪区'],[210122,'LiaoZhongXian','辽中县'],[210123,'KangPingXian','康平县'],[210124,'FaKuXian','法库县'],[210181,'XinMinShi','新民市']];

CITY[2102]=[[210202,'ZhongShanQu','中山区'],[210203,'XiGangQu','西岗区'],[210204,'ShaHeKouQu','沙河口区'],[210211,'GanJingZiQu','甘井子区'],[210212,'LvShunKouQu','旅顺口区'],[210213,'JinZhouQu','金州区'],[210224,'ZhangHaiXian','长海县'],[210281,'WaFangDianShi','瓦房店市'],[210282,'PuLanDianShi','普兰店市'],[210283,'ZhuangHeShi','庄河市']];
...
CITY[2111]=[[211102,'ShuangTaiZiQu','双台子区'],[211103,'XingLongTaiQu','兴隆台区'],[211121,'DaWaXian','大洼县'],[211122,'PanShanXian','盘山县']];
...
CITY[3101]=[[310101,'HuangPuQu','黄浦区'],[310102,'LuWanQu','卢湾区'],[310103,'XuHuiQu','徐汇区'],[310104,'ZhangNingQu','长宁区'],[310105,'JingAnQu','静安区'],[310106,'PuTuoQu','普陀区'],[310107,'ZhaBeiQu','闸北区'],[310108,'HongKouQu','虹口区'],[310109,'YangPuQu','杨浦区'],[310110,'MinHangQu','闵行区'],[310111,'BaoShanQu','宝山区'],[310112,'JiaDingQu','嘉定区'],[310113,'PuDongXinQu','浦东新区'],[310114,'NanHuiQu','南汇区'],[310115,'FengXianQu','奉贤区'],[310116,'SongJiangQu','松江区'],[310117,'JinShanQu','金山区'],[310118,'QingPuQu','青浦区'],[310119,'ChongMingXian','崇明县']];
...
CITY[3206]=[[320602,'ChongChuanQu','崇川区'],[320611,'GangZhaQu','港闸区'],[320621,'HaiAnXian','海安县'],[320623,'RuDongXian','如东县'],[320681,'QiDongShi','启东市'],[320682,'RuGaoShi','如皋市'],[320683,'TongZhouShi','通州市'],[320684,'HaiMenShi','海门市']];
...
CITY[34]=[[3401,'HeFeiShi','合肥市'],[3402,'WuHuShi','芜湖市'],[3403,'BangBuShi','蚌埠市'],[3404,'HuaiNanShi','淮南市'],[3405,'MaAnShanShi','马鞍山市'],[3406,'HuaiBeiShi','淮北市'],[3407,'TongLingShi','铜陵市'],[3408,'AnQingShi','安庆市'],[3410,'HuangShanShi','黄山市'],[3411,'ChuZhouShi','滁州市'],[3412,'FuYangShi','阜阳市'],[3413,'XiuZhouShi','宿州市'],[3414,'ChaoHuShi','巢湖市'],[3415,'LiuAnShi','六安市'],[3416,'BoZhouShi','亳州市'],[3417,'ChiZhouShi','池州市'],[3418,'XuanChengShi','宣城市']];

CITY[3401]=[[340102,'YaoHaiQu','瑶海区'],[340103,'LuYangQu','庐阳区'],[340104,'ShuShanQu','蜀山区'],[340111,'BaoHeQu','包河区'],[340121,'ZhangFengXian','长丰县'],[340122,'FeiDongXian','肥东县'],[340123,'FeiXiXian','肥西县']];
...
CITY[3414]=[[341402,'JuChaoQu','居巢区'],[341421,'LuJiangXian','庐江县'],[341422,'WuWeiXian','无为县'],[341423,'HanShanXian','含山县'],[341424,'HeXian','和县']];
...
CITY[3708]=[[370802,'ShiZhongQu','市中区'],[370811,'RenChengQu','任城区'],[370826,'WeiShanXian','微山县'],[370827,'YuTaiXian','鱼台县'],[370828,'JinXiangXian','金乡县'],[370829,'JiaXiangXian','嘉祥县'],[370830,'WenShangXian','汶上县'],[370831,'SiShuiXian','泗水县'],[370832,'LiangShanXian','梁山县'],[370881,'QuFuShi','曲阜市'],[370882,'YanZhouShi','兖州市'],[370883,'ZouChengShi','邹城市']];
...
CITY[4107]=[[410702,'HongQiQu','红旗区'],[410703,'XinHuaQu','新华区'],[410704,'BeiZhanQu','北站区'],[410711,'JiaoQu','郊区'],[410721,'XinXiangXian','新乡县'],[410724,'HuoJiaXian','获嘉县'],[410725,'YuanYangXian','原阳县'],[410726,'YanJinXian','延津县'],[410727,'FengQiuXian','封丘县'],[410728,'ZhangYuanXian','长垣县'],[410781,'WeiHuiShi','卫辉市'],[410782,'HuiXianShi','辉县市']];
...
CITY[42]=[[4201,'WuHanShi','武汉市'],[4202,'HuangShiShi','黄石市'],[4203,'ShiYanShi','十堰市'],[4205,'YiChangShi','宜昌市'],[4206,'XiangFanShi','襄樊市'],[4207,'EZhouShi','鄂州市'],[4208,'JingMenShi','荆门市'],[4209,'XiaoGanShi','孝感市'],[4210,'JingZhouShi','荆州市'],[4211,'HuangGangShi','黄冈市'],[4212,'XianNingShi','咸宁市'],[4213,'SuiZhouShi','随州市'],[4228,'EnShiTuJiaZuMiaoZuZiZhiZhou','恩施土家族苗族自治州']];
...
CITY[53]=[[5301,'KunMingShi','昆明市'],[5303,'QuJingShi','曲靖市'],[5304,'YuXiShi','玉溪市'],[5305,'BaoShanShi','保山市'],[5306,'ZhaoTongShi','昭通市'],[5307,'LiJiangShi','丽江市'],[5323,'ChuXiongYiZuZiZhiZhou','楚雄彝族自治州'],[5325,'HongHeHaNiZuYiZuZiZhiZhou','红河哈尼族彝族自治州'],[5326,'WenShanZhuangZuMiaoZuZiZhiZhou','文山壮族苗族自治州'],[5327,'SiMaoDiQu','思茅地区'],[5328,'XiShuangBanNaDaiZuZiZhiZhou','西双版纳傣族自治州'],[5329,'DaLiBaiZuZiZhiZhou','大理白族自治州'],[5331,'DeHongDaiZuJingPoZuZiZhiZhou','德宏傣族景颇族自治州'],[5333,'NuJiangLiSuZuZiZhiZhou','怒江傈僳族自治州'],[5334,'DiQingCangZuZiZhiZhou','迪庆藏族自治州'],[5335,'LinCangDiQu','临沧地区']];
...
CITY[63]=[[6301,'XiNingShi','西宁市'],[6321,'HaiDongDiQu','海东地区'],[6322,'HaiBeiCangZuZiZhiZhou','海北藏族自治州'],[6323,'HuangNanCangZuZiZhiZhou','黄南藏族自治州'],[6325,'HaiNanCangZuZiZhiZhou','海南藏族自治州'],[6326,'GuoLuoCangZuZiZhiZhou','果洛藏族自治州'],[6327,'YuShuCangZuZiZhiZhou','玉树藏族自治州'],[6328,'HaiXiMengGuZuCangZuZiZhiZhou','海西蒙古族藏族自治州']];
...
mt.city=function(s0,s1,s2,dv)
{
  ...
  }else
  {
    ...
    document.write("<select id='"+id+"' name='"+s0+"' onchange=\"addcard(this,'"+dv+"');\"><option value=''>--------------</select>");
    if(s1)
    {
      document.write("<select name='"+s1+"' onchange=\"addcard(this,'"+dv+"');\" style='margin-left:3px'><option value=''>--------------</select>");
      if(s2)
      {
        _cb=true;
        document.write("<select name='"+s2+"' style='margin-left:3px'><option value=''>--------------</select>");
      }
    }
    addcard($$(id),dv);
  }
};
function addcard(s,dv)
{
  var ob=s.id?s:s.nextSibling;
  if(!ob||ob.tagName!='SELECT')return;
  ...
  if(!_cb)//直辖市，忽略二级
  {
    if(fid=="11"||fid=="12"||fid=="31"||fid=="50")fid+="01";
  }
  var c=CITY[fid||0];
  for(var i=0;i<c.length;i++)
  {
    op[i+1]=new Option(c[i][lang+1],c[i][0]);
    if(dv.indexOf(c[i][0])!=0 && dv!=c[i][1])continue;
    op[i+1].selected=true;
  }
  if(ob.onchange)ob.onchange();
}
...
function getSrarea(id1,id2){
    var str = "";
    for(var i=0;i<CITY[id1].length;i++){
        if(CITY[id1][i][0]==id2){
            str = CITY[id1][i][2];
            break;
        }
...
mt.cityjson=function(s0,s1,s2,dv)
{
    debugger
    var jsonstr = "";
    var h='';
    ...
    {
        var id='m'+Math.random();
        jsonstr.append("<select id='"+id+"' name='"+s0+"' onchange=\"addcard(this,'"+dv+"');\"><option value=''>--------------</select>");
            //document.write("<select id='"+id+"' name='"+s0+"' onchange=\"addcard(this,'"+dv+"');\"><option value=''>--------------</select>");
        if(s1)
        {
            jsonstr.append("<select name='"+s1+"' onchange=\"addcard(this,'"+dv+"');\" style='margin-left:3px'><option value=''>--------------</select>");
            //document.write("<select name='"+s1+"' onchange=\"addcard(this,'"+dv+"');\" style='margin-left:3px'><option value=''>--------------</select>");
            if(s2)
            {
                _cb=true;
                jsonstr.append("<select name='"+s2+"' style='margin-left:3px'><option value=''>--------------</select>");
                //document.write("<select name='"+s2+"' style='margin-left:3px'><option value=''>--------------</select>");
            }
        }
        addcard($$(id),dv);
