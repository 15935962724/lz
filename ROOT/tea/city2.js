...
cityArray[34] = new Array("其它","北美洲|南美洲|亚洲|非洲|欧洲|大洋洲");
         function getCity(currProvince,city2)
         {
             //当前 所选择 的 省
             ...
             for (i = 0 ;i <cityArray.length;i++)
               {   
                   ...
                   if(cityArray[i][0]==currProvince)
                     ...
                     {
                    	 document.all.selCity.options[0] = new Option('-市-',0);
                     }
               }
             if(city2!='')
              {
            	 document.getElementById('selCity').options[ivs].selected = true;
              }
