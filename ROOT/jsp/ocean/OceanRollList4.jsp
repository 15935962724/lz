...
<form action="/jsp/ocean/OceanRollList4.jsp" name="form1">
...
%>>学生</option></select></td><td>海洋护照编号：</td><td><input type="text"  name="oceancards" value="<%=oceancards%>"/></td><td><input type="submit"  value="查询"/></td>
</tr>
</table>
</form>
...
for(int i=0;eu.hasMoreElements();i++)
{
  ...
  <tr>
    ...
    <td><input type="button" value="更改海洋护照编号" onclick="window.open('/jsp/ocean/EditOceanRoll4.jsp?ids=<%=oid%>&oceancard=<%=oce.getOceancard()%>','_self')"></td></tr>
  <%
}
%>
