...
<input type="button" value="导出word" onClick="window.open('/jsp/ocean/OceanWord.jsp?ids=<%=ids%>','_self')"></td>
  ...
  <tr>
    ...
    <td width="80" nowrap rowspan="3" class="tdte2"><img src="<%if(oce.getPicpath()!=null && oce.getPicpath().length()>0){out.print(oce.getPicpath());}else{out.print("/tea/image/oceanRoll/phonomember.jpg");}%>" width="100"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td nowrap colspan="2"><%if(oce.getTelephone()!=null)out.print(oce.getTelephone());%></td>
  </tr>
  <tr>
 ...
 <tr>
<td class="td01">其他：</td>   <td colspan="4">
        <label>
          <%
  ...
  <tr>
     ...
     <td colspan="4">
      <label>
      <input type="text" name="oceancard" value="<%if(oce.getOceancard()!=null)out.print(oce.getOceancard());%>">
      </label></td>
  </tr>
</table>
