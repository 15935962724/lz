...
for(int index=1;enumer.hasMoreElements();index++)
{
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td><input type=button value=调看 onclick="window.open('/jsp/copyright/CrupdateView.jsp?community=<%=teasession._strCommunity%>&crupdate=<%=id%>','','height=500,width=700,status=no,toolbar=no,menubar=no,location=no');" >
        <input type=button value=编辑 onclick="window.open('/jsp/copyright/EditCrupdate.jsp?community=<%=teasession._strCommunity%>&crupdate=<%=id%>&nexturl='+encodeURIComponent(location),'_self');" >
        <input type=button value=删除 onclick="if(confirm('确定删除吗？'))window.open('/servlet/EditCopyRight?community=<%=teasession._strCommunity%>&crupdate=<%=id%>&act=deletecrupdate&nexturl='+encodeURIComponent(location),'_self');" >
    </td>
 </tr>
<%
}
...
<input type=button value=添加 onclick="window.open('/jsp/copyright/EditCrupdate.jsp?community=<%=teasession._strCommunity%>&crupdate=0&nexturl='+encodeURIComponent(location),'_self');" >
<input type=button value=导入 onclick="window.open('/jsp/copyright/CrImport.jsp?community=<%=teasession._strCommunity%>&act=crupdate&nexturl='+encodeURIComponent(location),'_self');" >
