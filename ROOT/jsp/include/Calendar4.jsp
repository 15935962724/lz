...
Calendar.prototype.draw = function() {
  ...
  for(var i = 0; i < 6;i++){
    ...
    for(var j = 0; j < 7; j++) {
      if (j == 0){
        mvAry[mvAry.length]  = '  <td style="cursor:default;font-size:12px;color:' + calendar.colors["sun_word"] + ';"></td>';
      } else if(j == 6) {
        mvAry[mvAry.length]  = '  <td style="cursor:default;font-size:12px;color:' + calendar.colors["sat_word"] + ';"></td>';
      } else {
        mvAry[mvAry.length]  = '  <td style="cursor:default;font-size:12px;"></td>';
      }
    }
    mvAry[mvAry.length]  = '    </tr>';
  }
