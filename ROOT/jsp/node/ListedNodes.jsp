...
String sql=" AND n.rcreator="+DbAdapter.cite(teasession._rv._strR)+" AND node IN(SELECT node FROM Listed)";
...
<body>
<h1><%=j%> <%=r.getString(teasession._nLanguage, "ListedNodes")%></h1>
<div id="head6"><img height="6" src="about:blank"></div>

  <div id="PathDiv"><%=TeaServlet.hrefGlance(teasession._rv)%> ><A HREF="/jsp/node/Nodes.jsp"><%=r.getString(teasession._nLanguage, "Nodes")%></A> ><%=r.getString(teasession._nLanguage, "ListedNodes")%></div>
...
else
{
  ...
  while(e.hasMoreElements())
  {
    ...
    out.print("<tr onmouseover=bgColor='#BCD1E9' onMouseOut=bgColor=''><td>"+Node.find(k).getAncestor(teasession._nLanguage)+"</td></tr>");
  }
}
%>
</table>
