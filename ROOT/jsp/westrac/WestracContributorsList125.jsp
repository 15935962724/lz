...
<div class="title">在线投稿</div>
<div class="con">
<div class="tipTitle">投稿提示</div>
<div class="tipCon">1、基本奖励计划：投稿即加1分，投稿被采用并发布加3分，稿件被采用为频道头条加6分。<br>
2、投稿人请务必填写姓名、工作单位、电子邮箱、手机等个人资料，并保证其真实性，以方便我们与您沟通。<br>
3、上传稿件时，文字、图片请尽量在正文编辑区上传。多图附件上传务必打包压缩！否则无法收到。<br>
4、一篇稿件仅允许投一个栏目，并只允许投一次，请勿一稿多投。凡被退稿的稿件，请勿再投。被退稿每次减1分。</div>
...
<tr>
	<td colspan="6"><div class="QuickEntry"><div class="left">快捷入口：</div>
