...
{
  message=0;//Message.createTempMessage(teasession._strCommunity,teasession._rv._strV);
}
int talkback=0;
...
<tr class="middle"><td class="memberleft"></td><td class="membercenter2">
  ...
  <DIV id="newmessage">
    ...
    <h2><span><%=r.getString(teasession._nLanguage, "新建信息")%></span></h2>
      ...
      <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
        <tr>
          ...
          <td>
            <textarea name="name"  cols="50" rows="2" readonly><%=name.toString()%></textarea>&nbsp;
            <a href=### onClick="f_open();">选择管理员</a>&nbsp;
      ...
      <iframe id="editor" src="/jsp/include/FCKeditor/editor/fckeditor.html?InstanceName=content&Toolbar=<%=teasession._strCommunity%>" width="650" height="300" frameborder="no" scrolling="no"></iframe>
...
<center>
        ...
        <input type="button" name="reset" value="取消" onClick="parent.ymPrompt.close();">
</center>
