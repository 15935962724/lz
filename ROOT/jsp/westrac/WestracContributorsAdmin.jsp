...
/*  if(form1.father.value==0)
  ...
  if(form1.keywords.value=='')
  {
    ...
    document.getElementById("GoFinishBut").value='';
    
   document.getElementById("GoFinish2But").disabled=true;
   document.getElementById("GoFinish2But").value='';
  form1.submit();
...
<style>
#tablecenter{width:710px;border:1px solid #4ABCFE;background:#F8FCFF;margin:5px 0px;}
...
#tablecenter td input#GoFinishBut{border:0px;width:110px;height:30px;margin-top:10px;cursor:pointer;background:url(/res/westrac/structure/tijiao2.jpg) no-repeat left top;}
#tablecenter td input#GoFinish2But{border:0px;width:160px;height:30px;margin-top:10px;cursor:pointer;background:url(/res/westrac/structure/quxiao.jpg) no-repeat left top;}
#tablecenter td input#GoFinish3But{border:0px;width:66px;height:30px;margin-top:10px;cursor:pointer;background:url(/res/westrac/structure/fanhui.jpg) no-repeat left top;}


.Submissioncon{border:1px solid #8EAFD7;background:#ECF3F7;margin-top:5px;font-size:12px;*height:100px;width:730px;margin:0px auto;text-align:center;}
...
<table border="0" align="center" cellpadding="0" cellspacing="0" id="tablecenter" class="dis" height="10">
<tr id="Contributors_1">
    <td nowrap align="right">*&nbsp;投稿栏目：</td>
    <td nowrap align="left">
      <select name="father">
        <option value="0">--请选择投稿栏目--</option>
        <option value="14010771" selected="selected">--请选择投稿栏目--</option>
       <%--  <%
