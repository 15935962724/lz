...
Profile9000 sv_obj=Profile9000.find(code);
if(!sv_obj.isExists()||!sv_obj.getPassword().equals(password)||(sv_obj.getMember()!=null&&sv_obj.getMember().length()>0))
{
	response.sendRedirect("/jsp/info/Alert.jsp?info="+URLEncoder.encode("卡号密码错误,或此卡已经被激活过.","UTF-8"));
	return;
}
...
<input type="hidden" name="act" value="9000storedvalue"/>

       
        <div id="toptu"><img src="/res/9000gw/u/0708/070810572.jpg"> </div> <div id="biankuang">
        <div id="toptitle"><img src="/res/9000gw/u/0707/070710526.jpg" align="absmiddle"></div><div id="center">激 活 信 息</div><div id="topwei"><img src="/res/9000gw/u/0707/070710527.jpg" align="absmiddle"></div></div>
          ...
          <div id="beijing">
			...
			<div style="float:left;"><input type=submit value="激活印象卡会员" id="jhyxk"></div>
          </div>
        </div>
