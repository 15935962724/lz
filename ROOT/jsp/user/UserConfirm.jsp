...
<script>
	...
	{
		 sendx("/jsp/user/UserConfirm.jsp?act=chongxin&user="+encodeURIComponent(m)+"&membertype="+i,
         function(data)
         {
	...
	{
		 sendx("/jsp/user/UserConfirm.jsp?act=newemail&user="+encodeURIComponent(m)+"&membertype="+i+"&newemail="+frm.newemail.value,
         function(data)
         {
             alert("<%=r.getString(teasession._nLanguage,"4657742383")%>.");
         }
