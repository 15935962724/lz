...
request.setCharacterEncoding("UTF-8");
  ...
  StringBuffer sql=new StringBuffer(" and t.member="+DbAdapter.cite(teasession._rv.toString()));
...
if(member!=null && member.length()>0)
{
  ...
  int count=Telephonist.countBy(teasession._strCommunity,sql.toString());
  int pos=0;
  int pageSize=20;
...
<div id="tablebgnone" class="register">
  ...
  <tr>
    <td>
    会员ID:<input name="member" value="<%if(member!=null)out.print(member);%>" type="text">
    订单时间：从
...
//       java.util.Enumeration e = Destine.findBy(teasession._strCommunity,sql.toString(),pos,pageSize);
       java.util.Enumeration e = Telephonist.findBy(teasession._strCommunity,sql.toString(),pos,pageSize);
