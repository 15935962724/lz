...
<!-------------- 月 ------------>
        <input type="button" value="&laquo;"  style="height:20;position: relative;top:-1;left:-1" class="SmallButton" title="上一月" onclick="set_mon(-1);"><select name="MONTH" class="SmallSelect" onchange="set_mon(0);">
<%
        for(int I=1;I<=12;I++)
        {
          //if(I<10)
