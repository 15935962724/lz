...
function change()
{
	...
	{
		document.theform.linkmanName.value=document.theform.TxtName[0].value;
		document.theform.phone.value=document.theform.contacter_mobile.value;
		document.theform.linkmanPhoneStart.value=document.theform.contacter_mobile_1.value;
		document.theform.linkmanPhoneEnd.value=document.theform.contacter_mobile_2.value;
		var sex;
	...
	{
		document.theform.linkmanName.value="";
		document.theform.phone.value="";
		document.theform.linkmanPhoneStart.value="";
		document.theform.linkmanPhoneEnd.value="";
	}
          ...
          <table width="750" border="0" cellspacing="1" cellpadding="0">
             ...
             <tr>
              <td height="30" bgcolor="#E5F6E4">　　入住人数：　　
                <select name="humanCount" id="humanCount" onchange="javascript:ChangeGuest(this.value);">
                  <option selected value="1">1</option>
                  <option value="2">2</option>
                  <option value="3">3</option>
                </select> <font color="#1EA817">※</font></td>
...
<input name="humanName" type="text" class="inputmodify" style="width:80px;display:none" onfocus="javascript:document.theform.IndexOfGuest.value='1';" onmouseover="javascript:this.select();this.focus();">
<input name="humanName" type="text" class="inputmodify" style="width:80px;display:none" onfocus="javascript:document.theform.IndexOfGuest.value='2';" onmouseover="javascript:this.select();this.focus();">
<input name="humanName" type="text" class="inputmodify" style="width:80px;display:none" onfocus="javascript:document.theform.IndexOfGuest.value='3';" onmouseover="javascript:this.select();this.focus();">
<input name="humanName" type="text" class="inputmodify" style="width:80px;display:none" onfocus="javascript:document.theform.IndexOfGuest.value='4';" onmouseover="javascript:this.select();this.focus();">
<input name="humanName" type="text" class="inputmodify" style="width:80px;display:none" onfocus="javascript:document.theform.IndexOfGuest.value='5';" onmouseover="javascript:this.select();this.focus();">
<input name="humanName" type="text" class="inputmodify" style="width:80px;display:none" onfocus="javascript:document.theform.IndexOfGuest.value='6';" onmouseover="javascript:this.select();this.focus();">
<input name="humanName" type="text" class="inputmodify" style="width:80px;display:none" onfocus="javascript:document.theform.IndexOfGuest.value='7';" onmouseover="javascript:this.select();this.focus();">
<input name="humanName" type="text" class="inputmodify" style="width:80px;display:none" onfocus="javascript:document.theform.IndexOfGuest.value='8';" onmouseover="javascript:this.select();this.focus();">
<input name="humanName" type="text" class="inputmodify" style="width:80px;display:none" onfocus="javascript:document.theform.IndexOfGuest.value='9';" onmouseover="javascript:this.select();this.focus();">
<input name="humanName" type="text" class="inputmodify" style="width:80px;display:none" onfocus="javascript:document.theform.IndexOfGuest.value='10';" onmouseover="javascript:this.select();this.focus();">
<input name="humanName" type="text" class="inputmodify" style="width:80px;display:none" onfocus="javascript:document.theform.IndexOfGuest.value='11';" onmouseover="javascript:this.select();this.focus();">
...
<input type="hidden" name="IndexOfGuest" value="0">
            ...
            <tr>
              <td height="30" bgcolor="#E5F6E4">　　手机号码：　　
                ...
                <input name="handset_1" type="text" class="inputmodify" value="<%=profile.getTelephoneStart(teasession._nLanguage)%>" style="width:50px;" size=4 maxlength=5>-<input type=text name=phone size=14 maxlength=20 value="<%=profile.getTelephoneEnd(teasession._nLanguage)%>" class="inputmodify" style="width:70px;"></td>
            </tr>
            <tr>
              <td height="30" bgcolor="#E5F6E4">　　房间类型：　　
			  高级园景房&nbsp;<font color="#1EA817">※</font></td>
            </tr>
<input type="hidden" value="高级园景房" name="roomType"/>
            <tr>
              <td height="30" bgcolor="#E5F6E4">　　住店日期：　　
			  <input class="text" type="text" maxLength="12" size="9" value="" name="kipDate" ID="Text3">&nbsp;<a href="javascript:ShowCalendar('kipDate')" target="_self"><img id="dimg3" style="POSITION: relative" src="/tea/image/section/10912.gif"  border="0" align="absmiddle"></a>　　离开日期：
			  <input class="text" type="text" maxLength="12" size="9" value="" name="leaveDate" ID="Text4">&nbsp;<a href="javascript:ShowCalendar('leaveDate')" target="_self"><img id="dimg4" style="POSITION: relative" src="/tea/image/section/10912.gif"  border="0" align="absmiddle"></a>&nbsp;&nbsp; <font color="#1EA817">※</font></td>
            </tr>
            <tr>
              <td height="30" bgcolor="#E5F6E4">　　最早到达时间：
                <select name="earlyArrive" id="earlyArrive" onChange="javascript:SetLateTime()">
            ...
            <tr>
              <td height="30" bgcolor="#E5F6E4"><font color="#1EA817">　　</font>最晚到达时间：
                <select name="eveningArrive" id="eveningArrive" onChange="javascript:ChkLateTime()">
                  <option value="10:00">10:00</option>
                  <option value="10:30">10:30</option>
                  <option value="11:00">11:00</option>
                  <option value="11:30">11:30</option>
    ...
    <table width="750" height="30" border="0" cellpadding="0" cellspacing="0" bgcolor="#1EA817">
          <tr>
              <td style="color:white;">　<img src="/tea/image/section/10908.gif" width="13" height="13" align="absmiddle">
                ...
                <input  id=CHECKBOX type="CHECKBOX" name=linkmanName id=linkmanName onclick="javascript:change();">&nbsp;与入住人相同
          ...
          <table width="750" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
			  ...
			  <input name="linkmanHandset" type="text" class="inputmodify" style="width:148px;" value="" size="15"> <font color="#1EA817">※</font>　　如果没有手机，请留下座机号码：
                <input name="linkmanPhoneStart" type="text" class="inputmodify" style="width:50px;" size=4 maxlength=5>-<input type=text name=linkmanPhoneEnd size=14 maxlength=20 class="inputmodify" style="width:70px;"></td>
            </tr>
            <tr>
            ...
            <tr>
			  ...
			  <select name="linkmanAffirm">
                  <option value="noneed">不需确认<option value="mobile" selected>使用短信来确认<option value="linkmanHandset">使用电话来确认<option value="linkmanFax">使用传真来确认<option value="linkmanMail">使用e-mail来确认
                </select>
                <font color="#1EA817">※</font>　　　　　　　　　　　　</td>
            </tr>
            <tr>
