...
<tr>
	<td colspan="2" id="tabletr"><span   style="cursor:pointer" title="点击可以显示或隐藏个人信息"  onclick="f_m();">个人信息</span></td>
</tr>
</table>
<table border="0" align="center" cellpadding="0" cellspacing="0" id="tablecenter" height="10">
...
<!--
  ...
  <tr id="Contributors_9">
    ...
    <td align="center" colspan=2>
     ...
     <tr id="tsid" >
     <td colspan="2">　如果你上传的稿件是组图，请点击<a href="###" onclick="f_te();return false;">这里</a></td>
     </tr>
      ...
      <input name="filepath" type="file" class="edit_input" style="width:418px" onchange="f_checkinput('form1.filepath');">
       ...
       <%
      int len2 = 0;
      String file=nobj.getFile(teasession._nLanguage);
      if(file!=null&&file.length()>2)
      {
        file=file.split("[|]")[1];
        len2= (int)new java.io.File(application.getRealPath(file)).length();
      }
      if(len2 > 0)
      {
        out.print("<a href='"+file+"' target='_blank'>查看附件&nbsp;("+len2 +"Bytes)</a>");
