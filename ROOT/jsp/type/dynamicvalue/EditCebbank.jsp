...
//  String code=d.getType()+"-"+request.getParameter("assignee")+c.get(java.util.Calendar.YEAR)+obj.getPid();
  if(request.getParameter("GoGrant")!=null)
  {
    ...
    java.net.URL url=new java.net.URL("http://"+request.getServerName()+":"+request.getServerPort()+"/jsp/type/dynamicvalue/DynamicValuePdfView.jsp;jsessionid="+session.getId()+"?node="+node._nNode);
    java.io.InputStream is=url.openStream();
    java.io.File file=java.io.File.createTempFile("html2pdf_",".html");
    java.io.File file2=java.io.File.createTempFile("html2pdf_",".pdf");

    java.io.FileOutputStream fos=new java.io.FileOutputStream(file);
    fos.write(("<base href=\""+url.toString()+"\" />").getBytes("UTF-8"));
    int value=0;
    ...
    if(tea.ui.util.XToX.htmlToPdf(file.getAbsolutePath(),file2.getAbsolutePath()))
    {
      java.io.FileInputStream fis=new java.io.FileInputStream(file2);
  ...
  response.sendRedirect("/jsp/info/Succeed.jsp?nexturl="+java.net.URLEncoder.encode("/jsp/type/dynamicvalue/DynamicValues.jsp?node="+teasession._nNode+"&community="+s,"UTF-8"));
  return;
}
