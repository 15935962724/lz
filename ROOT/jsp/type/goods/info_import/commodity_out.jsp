...
<%-- <td id = "show2"> <select> <option value="">----------</option></select></td>--%>
<td id = "show3"> 品牌:<select ><option value="">----------</option> </select></td>




<td>时间<input name="time" type="text"><img src="/tea/image/public/Calendar2.gif" onclick="showCalendar('form1_gs.time');" /></td>
...
<form name="form1" action="/servlet/EditCommodityOutExcel" method="POST" >
