...
<body id="bodynone">
 <h1>客户端登录管理</h1>
  ...
  <form action="/jsp/type/lvyou/Logs.jsp" name="form1" method="Get">
    ...
    <tr>
    <td>登录ID</td><td><input type="text" name="name" value="<%=name %>"></td>
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
   <tr>
    ...
    Enumeration logs =Logs.find(sql+ " GROUP BY vmember", pos, pageSize);
    
       int count=Logs.coutmember(sql);
    ...
    %>
     <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
         ...
         <td><a href="/jsp/type/lvyou/LogDetails.jsp?name=<%=profile.getMember()%>"><%=profile.getName(1)  %></a></td>
         <td><%=profile.getMember()%></td>
         <td><%=Logs.count(profile.getMember(), 99) %></td>
         <td><%=Entity.sdf2.format(Logs.getLastLoginClient(profile.getMember())) %></td>
