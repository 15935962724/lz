...
StringBuffer sql = new StringBuffer(" and n.path like "+DbAdapter.cite("%/"+teasession._nNode+"/%")+" and n.type = 94 ");
...
<input type="hidden" name="files" value="作品统计"/>
...
<h2>查询</h2>
 ...
 %>
<h2>作品列表&nbsp;(&nbsp;目前作品总计为&nbsp;<font color="#000000" size="3"><%=count%></font>&nbsp;&nbsp;)&nbsp;
