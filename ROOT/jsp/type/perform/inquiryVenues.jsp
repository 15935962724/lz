...
<form name="form1" action="?" method="GET" target="tar">
 ...
 <% 
    ...
    for(int i =1;e.hasMoreElements();i++)
    {
      ...
      %>
      <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''" onclick="f_x('<%=nid %>');" title="点击可以选中场馆"  style="cursor:pointer">
        <td width="1"><%=i+pos %></td>
