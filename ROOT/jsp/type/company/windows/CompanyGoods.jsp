...
for(int i=0;i<10&&e.hasMoreElements();i++)
{
  ...
  %>
  <td valign="top">
<table border="0" cellpadding="0" cellspacing="0" id="goodslist"><tr><td id="goodssmallpicturespan"><a href="/servlet/Node?node=<%=id%>"  target="_blank"><img onerror="if(this.src.indexOf('goods_no_photo.jpg')==-1)this.src='/tea/image/eyp/goods_no_photo.jpg';" id=goodssmallpicture src="<%=g.getSmallpicture()%>"></a></td></tr><tr><td id="goodsname"><a href="/servlet/Node?node=<%=id%>" target="_blank"><%=n.getSubject(teasession._nLanguage)%></a></td></tr></table>	  
  </td>
<%
}%>
</table>
