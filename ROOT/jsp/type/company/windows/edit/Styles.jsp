...
<table>
  ...
  <tr>
    <td id="li_te"><span><%=r.getString(lang,"fj12hq3v")%></span></td>
  </tr>
  <tr>
...
<table id="huan_yif">
<%
String ss[]=new File(application.getRealPath("/tea/image/eyp/style/")).list();
for(int i=0;i<ss.length;i++)
{
  ...
  out.print("<td><img src=/tea/image/eyp/img_style/"+i+".jpg><br><input type=radio name=radio value="+ss[i]);
  if(i==0||ss[i].equals(es))
  out.print(" checked");
  out.print(">"+ss[i]+"</td>");
}
%>
</table>
<input type="submit" value="<%=r.getString(lang,"fj14p1y4")%>" />
