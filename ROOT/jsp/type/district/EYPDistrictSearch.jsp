...
{
	url="/jsp/type/district/EYPDistrictSearchResult.jsp?lucenelist=0&community="+teasession._strCommunity+"&t255_q="+URLEncoder.encode(q,"UTF-8");
}
...
function s(v,t)
{
  if(t)
  {
  	formcsf3.t255_path.value=v;
  }else
  {
  	formcsf3.t21_city.value=v;
  }
  formcsf3.submit();
}
...
<h3 id=companycallingh3 style="background-color:#EEF7FC"><a href="javascript:f2(true);">按地区</a></h3>
