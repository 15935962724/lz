...
<table width="550" border="0" align="center" cellpadding="4" cellspacing="1" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#b6b6b6" bgcolor="#999999">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td height="25">
      <font color="#000000"><%=profile.getTime()%></font>
    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td height="25">
      <font color="#000000"><%=tea.entity.node.Talkback.countIngNodes(teasession._rv)+tea.entity.node.TalkbackReply.countByMember(teasession._rv._strR)%></font>
    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
   ...
   http://<%=url%>
        &nbsp;&nbsp;&nbsp;
        <a href='http://<%=url%>' target=_blank>[预览我的网站]</a>
      </font>
    </td>
  </tr>
</table>
