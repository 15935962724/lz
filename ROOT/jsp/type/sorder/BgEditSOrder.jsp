...
//      }
      ...
      /*
      if(form1.subtract.value.length<=0)
      {
        form1.subtract.value='0';
      }else
      if(isNaN(parseFloat(form1.subtract.value)))
      {
        alert('扣除余额,填写错误.');
        form1.subtract.focus();
        return false;
      }
      if(form1.cash.value.length<=0)
      {
        form1.cash.value='0';
      }else
      if(isNaN(parseFloat(form1.cash.value)))
      {
        alert('支付,填写错误.');
        form1.cash.focus();
        return false;
...
<body>
<h1><%=r.getString(teasession._nLanguage, "BgEditSOrder")%></h1>
...
%>
  ...
  <table cellpadding="0" cellspacing="0" border="0" id="tablecenter">
	...
	%>
      ...
      <td>详细地址</td>
      <td colspan="3"><textarea name="detailaddress" readonly="readonly" cols="60" rows=""><%=so_obj.getAddress()%></textarea></td></tr>
    <tr>
      <td>预约时间</td>
      <td colspan="3">
    ...
    <tr>
      ...
      <td><input type="text" value="<%=so_obj.getAmount()[0]%>"   onKeyUp="fprice(form1.service[0],this,form1.price[0],form1.sum,form1.unit[0],form1.unitprice[0]);" onChange="fprice(form1.service[0],this,form1.price[0],form1.sum,form1.unit[0],form1.unitprice[0]);" name="amount"><input readonly=""  name="unit" id="unit" style=" border:#FFFFFF" size="5"  style=" border:#FFFFFF">
<input type="text"  readonly  size="5" name="unitprice" style=" border:#FFFFFF"/></td>
    ...
    <tr>
      ...
      <td><input type="text" value="<%=so_obj.getAmount()[1]%>"  onKeyUp="fprice(form1.service[1],this,form1.price[1],form1.sum,form1.unit[1],form1.unitprice[1]);" onChange="fprice(form1.service[1],this,form1.price[1],form1.sum,form1.unit[1],form1.unitprice[1]);"  name="amount"><input readonly=""  name="unit" id="unit" style=" border:#FFFFFF" size="5" style=" border:#FFFFFF">
<input type="text"  readonly  size="5" name="unitprice" style=" border:#FFFFFF"/>      </td>
      <td>￥</td>
      <td><input type="text" name="price" readonly="readonly" style=" border:#FFFFFF">
        元</td>
    ...
    <tr>
      ...
      <td><input type="text" value="<%=so_obj.getAmount()[2]%>"   onKeyUp="fprice(form1.service[2],this,form1.price[2],form1.sum,form1.unit[2],form1.unitprice[2]);" onChange="fprice(form1.service[2],this,form1.price[2],form1.sum,form1.unit[2],form1.unitprice[2]);" name="amount"><input readonly=""  name="unit" id="unit" style=" border:#FFFFFF" size="5" style=" border:#FFFFFF">
      <input type="text"  readonly  size="5" name="unitprice" style=" border:#FFFFFF"/></td>
      <td>￥</td>
      <td><input type="text" name="price" readonly="readonly" style=" border:#FFFFFF">
        元</td>
    ...
    <tr>
      ...
      <td><input type="text" value="<%=so_obj.getAmount()[3]%>"    onKeyUp="fprice(form1.service[3],this,form1.price[3],form1.sum,form1.unit[3],form1.unitprice[3]);" onChange="fprice(form1.service[3],this,form1.price[3],form1.sum,form1.unit[3],form1.unitprice[3]);"  name="amount"><input readonly=""  name="unit" id="unit" style=" border:#FFFFFF" size="5" style=" border:#FFFFFF">
      <input type="text"  readonly  size="5" name="unitprice" style=" border:#FFFFFF"/></td>
      <td>￥</td>
      <td><input type="text" name="price" readonly="readonly" style=" border:#FFFFFF" >
        元</td>
    ...
    <tr style="display:none">
      ...
      <td><input type="text" value="<%=so_obj.getAmount()[4]%>"  onKeyUp="fprice(form1.service[4],this,form1.price[4],form1.sum,form1.unit[4],form1.unitprice[4]);" onChange="fprice(form1.service[4],this,form1.price[4],form1.sum,form1.unit[4],form1.unitprice[4]);"  name="amount"><input readonly=""  name="unit" id="unit" style=" border:#FFFFFF" size="5" style=" border:#FFFFFF">
      <input type="text"  readonly  size="5" name="unitprice" style=" border:#FFFFFF"/></td>
      <td>￥</td>
      <td><input type="text" name="price" readonly="readonly" style=" border:#FFFFFF">
        元</td>
  ...
  <tr >
      ...
      <td><%--input type="text" value="<%=getNull(so_obj.getWaiter())%>" name="waiter"--%>
        <table cellspacing="0" bordercolordark="#ffffff" cellpadding="0" align="left" bordercolorlight="#666666" border="1">
            <tr align="center">
              <td width="140" valing=middle>选定作业员</td>
              <td width="50"  valing=middle>&nbsp;</td>
              <td width="140"  valing=middle>备选作业员</td>
            </tr>
            <tr>
...
//                                                  tea.entity.admin.Area az_obj=tea.entity.admin.Area.find(id);
              ...
              <td  valing=middle width="140">
                <select ondblclick="func_insert(form1.fromareaList,form1.waiter);" width="100%" style="WIDTH: 140px; HEIGHT: 180px" size="15" name="fromareaList" >
                  <%--
                  StringBuffer waiterfigure_script=new StringBuffer();
                  ...
                  while(waiter_enumer.hasMoreElements())
                  {
                   ...
                   tea.entity.node.Waiter waiter_temp=tea.entity.node.Waiter.find(ar_id,teasession._nLanguage);
                   if(waiter_temp.isFigure())
                   {
                     waiterfigure_script.append("form1.waiterfigure.add(new Option('"+waiter_temp.getCode()+"','"+ar_id+"'));");
                   }
                    %>
                  <option value=<%=ar_id%>><%=waiter_temp.getCode()%></option>
                  <%}--%>

                            <%
                            StringBuffer waiterfigure_script=new StringBuffer();
           waiter_enumer_a=tea.entity.admin.AdminZone.findByArea(so_obj.getArea());////根据"地区"查找"办事处"
          while(waiter_enumer_a.hasMoreElements())
          {
            int waiter_node=((Integer)waiter_enumer_a.nextElement()).intValue();
            ...
            {
              waiter_node=  ((Integer)waiter_enumer_sub.nextElement()).intValue();
              tea.entity.node.Waiter waiter_temp=tea.entity.node.Waiter.find(waiter_node,teasession._nLanguage);
              if(waiter_temp.isFigure())
              {
                waiterfigure_script.append("form1.waiterfigure.add(new Option('"+waiter_temp.getCode()+"','"+waiter_node+"'));");
              }
              out.print("<Option ");
//              if(waiter_node==so_obj.getExwaiter())
//              out.print(" SELECTED ");
              out.print(" VALUE="+waiter_node+">"+waiter_temp.getCode()+"</option>");
                ...
                <script type="">
                <%=
                waiterfigure_script.toString()
                %>
                for(index=0;index<form1.waiterfigure.length;index++)
                {
                  if(form1.waiterfigure[index].value=='<%=so_obj.getWaiterFigure()%>')
                  {
                    form1.waiterfigure.selectedIndex=index;
                    break;
                  }
                }
    ...
    <tr>
      ...
      } else//管理员查看*/
      {
        ...
        {
          case 4: // 已接收订单
          tea.html.Radio start0_2= new Radio("Status",2, true);
