...
<table border="0" cellspacing="0" cellpadding="5">
    <form action="/servlet/Event?node=14995&Listing=5484&id=5721"  style="margin:-right:80px;"><!--//在id=的后面添加列举号-----是检索的列举号，而不是"要检索对象的列举号"----->
<tr>
       ...
       for(int i=0;i<42;i++)
       {
           ...
           if(i>WEEK234-1&&sum>=i-WEEK234+1)
           {
               ...
               if(tea.entity.node.Event.exists(YEAR,MONTH,i-WEEK234+1,teasession._nLanguage))
               {
                   ...
                   out.println("<a target=\"_parent\" href='/servlet/Event?node=14995&Listing=5484&timeStart="+YEAR+strMonth+strDay+"&id=5721'>");//在id=的后面添加列举号----------
               }
