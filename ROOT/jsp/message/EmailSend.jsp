...
tmp=request.getParameter("emailbox");
...
<HEAD>
  ...
  function f_open()
  {
    window.open('/jsp/user/list/SelMembers2.jsp?community=<%=teasession._strCommunity%>&member=form1.to&unit=form1.tunit&name=form1.name','','width=450px,height=350px,top=300px,left=400px');
  }
  function f_clear()
  {
    form1.to.value="/";
  ...
  <DIV id="newmessage">
    ...
    <div id="head6"><img height="6" src="about:blank"></div>
      ...
      <input type="hidden" name="emailbox" value="<%=emailbox%>">
      ...
      <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
        ...
        <tr>
          <td>外部人员:</td>
          <td><textarea name="email" cols="50" rows="2"></textarea>
            <input type="button" value="添加" onclick="window.showModalDialog('/jsp/sms/psmanagement/FrameGU.jsp?field=email&index=form1.email&add=on',self,'dialogWidth:450px;dialogHeight:350px;help:0')"/>
            <input type="button" value="清空" onclick="form1.email.value='';"/></td>
        </tr>
        <tr>
