...
<table border="0" cellspacing="0" cellpadding="0" id="tablecenter">
  <tr>
    <td><h2><%=r.getString(teasession._nLanguage,"1216086736724")%></h2></td>
  </tr>
  <tr><td>
  ...
  <tr>
    <td align="center">
      <table border=0 cellpadding=2>
        ...
        if (year!=cdate.getYear()+1900 || month!= cdate.getMonth()+1){
        alltotal=NodeAccessWhere.countByCommunity(community,year,month);
        allt=NodeAccessWhere.countByCommunity1(community,year,month);
        total=alltotal/100F;
         al =NodeAccessWhere.findByCommunity(community,year,month,pos,15);
        }else
        {   	
        	  alltotal=NodeAccessWhere.countByCommunity(community,year,month,day);
        	  allt=NodeAccessWhere.countByCommunity1(community,year,month,day);
              total=alltotal/100F;
               al =NodeAccessWhere.findByCommunity(community,year,month,day,pos,15);
        }
        int j=al.size()/2;
...
<%=new tea.htmlx.FPNL(teasession._nLanguage, "/jsp/count/index.jsp?act=where&community=" + community +"&year="+year+"&month="+month+"&day="+day+ "&pos=", pos,allt,15)%>
      </table></td>
  </tr>
</table>
