...
%>
    ...
    <tr><td align="center"><img src="/tea/image/other/bar.gif" class="gra" ><%=r.getString(teasession._nLanguage,"1216028526694")%><%=df.format(nam.getSumPv())%> PV
      <img src="/tea/image/other/bar3.gif" class="gra" ><%=r.getString(teasession._nLanguage,"1216085236162")%><%=df.format(nam.getSumIp())%> IP</td></tr>
...
%>
 ...
 <tr><td align="center"><img src="/tea/image/other/bar.gif" class="gra" ><%=r.getString(teasession._nLanguage,"1216028526694")%><%=df.format(nam2.getSumPv()+oldpv)%> PV
   <img src="/tea/image/other/bar3.gif" class="gra" ><%=r.getString(teasession._nLanguage,"1216085236162")%><%=df.format(nam2.getSumIp()+oldip)%> IP</td></tr>
</table>
