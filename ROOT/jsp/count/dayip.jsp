...
for(int i=curday;i<k;i++)
{
  ...
  out.print("<td align=center width=15 height=120 nowrap><img src=/tea/image/other/bar3.gif width=15 height="+_nHeight2+" title='"+title+"'><br>"+(i+1)+"</td>");
}
