...
for(int i=curday;i<k;i++)
{
  ...
  String title=r.getString(teasession._nLanguage,"1216028449131")+year+"-"+(month-1)+"-"+(i+1)+"&#13;"+r.getString(teasession._nLanguage,"1216028526694")+df.format(pv[i])+" PV&#13;"+r.getString(teasession._nLanguage,"1216085236162")+df.format(ip[i])+" IP";
  out.print("<td align=center width=15 height=120 nowrap><img src=/tea/image/other/bar.gif width=15 height="+(sHeight-_nHeight2)+" id=htav title='"+title+"'><img src=/tea/image/other/bar3.gif width=15 height="+_nHeight2+" title='"+title+"'><br>"+(i+1)+"</td>");
}
...
%>
        ...
        <tr>
          <td align="center">
            <img src="/tea/image/other/bar.gif" class="gra" align="top"/><%=r.getString(teasession._nLanguage,"1216028526694")%><%=df.format(nad.getSumPv())%> PV　
            <img src="/tea/image/other/bar3.gif" class="gra" align="top"/><%=r.getString(teasession._nLanguage,"1216085236162")%><%=df.format(nad.getSumIp())%> IP
          </td>
        </tr>
...
%>
 ...
 <tr><td align="center"><img src="/tea/image/other/bar.gif" class="gra" align="top"><%=r.getString(teasession._nLanguage,"1216028526694")%><%=df.format(nad2.getSumPv()+oldpv)%> PV　
   <img src="/tea/image/other/bar3.gif" class="gra" align="top"><%=r.getString(teasession._nLanguage,"1216085236162")%><%=df.format(nad2.getSumIp()+oldip)%> IP</td></tr>
</table>
