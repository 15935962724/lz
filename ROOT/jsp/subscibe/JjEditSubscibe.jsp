...
<form name="form_subscibe" method="post" action="/servlet/Subscibes2" TARGET="form_subscibe_iframe" onSubmit="return submitText(this.email,'无效邮件地址');" >
...
{
%>
E-Mail:<input type="text" name="email" value="<%=semail %>" size="80">
