...
<table cellpadding="0" cellspacing="0" bordercolor="0" id="tablecenter">
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td>1200--8800</td>
    <td>北京日居科技</td>
    <td><input name="button5" type=button value="&nbsp;查阅&nbsp;" onClick="window.open('/jsp/cpcc/Announcement_1.jsp', '_blank','scrollbars=yes');"></td>
  </tr>
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    <td><input type="checkbox" name="trades" value=""/></td>
    <td>2007SRBJ5641</td>
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td>65500-7300</td>
    <td>杭州国电升源科技有限公司</td>
    <td><input name="button" type=button value="&nbsp;查阅&nbsp;"></td>
  </tr>
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    <td><input type="checkbox" name="trades" value=""/></td>
    <td>2007SRBJ5641</td>
