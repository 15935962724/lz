...
<table cellpadding="0" cellspacing="0" bordercolor="0" id="tablecenter">
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td><input name="button53" type=button value="查看详细" onClick="window.open('/jsp/cpcc/turnaccept/AuthorInfo_1.jsp', '_blank','width=750,height=600,scrollbars=yes');"><input type="button" value="编辑" onClick="window.open('/jsp/cpcc/turnaccept/AuthorInfo_Edit.jsp','_self')"><input type="button" value="删除"></td>
  </tr>
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td><input name="button5" type=button value="查看详细" onClick="window.open('/jsp/cpcc/turnaccept/AuthorInfo_1.jsp', '_blank','width=750,height=600,scrollbars=yes');"><input type="button" value="编辑" onClick="window.open('/jsp/cpcc/turnaccept/AuthorInfo_Edit.jsp','_self')"><input type="button" value="删除"></td>
  </tr>
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
