...
<table cellpadding="0" cellspacing="0" bordercolor="0" id="tablecenter">
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td>1200--8800</td>
    <td>北京日居科技</td>
    <td><input name="button5" type=button value="查看详细" onClick="window.open('/jsp/cpcc/CashCheck_1.jsp', '_blank','width=750,height=600,scrollbars=yes');"><input name="button2" type=button value="通过受理"><input name="button3" type=button value="不通过受理" onClick="window.open('/jsp/cpcc/Accept_2.jsp', '_blank','width=750,height=600,scrollbars=yes');"></td>
  </tr>
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    <td><input type="checkbox" name="trades" value=""/></td>
    <td>80206686655</td>
...
<div style="text-align:center"><input name="button" type=button value="所有勾选通过受理"></div>
</FORM>
<div id="head6"><img height="6" src="about:blank"></div>
