...
<FORM name="formform111" METHOD=POST action="?" >
         ...
         while(db.next())
         {
           ...
           <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
            ...
            if(code.length()>0)
            {
              ...
              out.print("<input type=button value="+r.getString(teasession._nLanguage,"1215740260334")+" onclick=window.open('/jsp/confab/ConfabQrcView.jsp?node="+nodeobj._nNode+"','','width=500px,height=300px');>");
