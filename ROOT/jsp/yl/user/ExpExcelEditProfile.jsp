...
<input name='nexturl' type="hidden" value="/jsp/yl/shop/ExpExcelShouhuoren.jsp" />
<input name='act' type="hidden" value="uploadfile_shou" />
<table id="tablecenter">
	<tr><td >模板</td><td ><a href="/res/Excel/shouhuoren.xlsx">点击下载</a></td></tr>
