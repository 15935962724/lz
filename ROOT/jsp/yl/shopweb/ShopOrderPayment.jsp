		...
		<div class="order-zh">
			...
			<%
				if(Config.getInt("tongfu")==so.getPuid()){
					...
					out.print("<li><span>户     名：</span> 原子高科股份有限公司</li>");
					out.print("<li><span>帐     号：</span> 0200026609200003075</li>");
					out.print("<li><span>开户行：</span> 北京市工商行房山支行266分理处</li>");
					out.print("<li></li>");
					
					out.print("<li><span>户     名：</span> 原子高科股份有限公司</li>");
					out.print("<li><span>帐     号：</span> 01091448700120105029094</li>");
					out.print("<li><span>开户行：</span> 北京银行中关村海淀园支行</li>");
				} if(Config.getInt("junan")==so.getPuid()){
					out.print("<li><span>户     名：</span> 宁波君安药业科技有限公司</li>");
					out.print("<li><span>帐     号：</span> 82210220101001890</li>");
					out.print("<li><span>开户行：</span> 宁波银行马园支行</li>");
				}
			%>
