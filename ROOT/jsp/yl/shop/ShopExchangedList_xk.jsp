...
Integer puid = Config.getInt("xinke");

sql.append(" AND sod.order_id in(select order_id from shopOrderData where product_id in(select product from shopproduct where product in(15010264,15010269)) )");
