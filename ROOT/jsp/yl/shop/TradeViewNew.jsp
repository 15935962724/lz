...
<input type="hidden" name="act" value="staten"/>
...
if(t.state==1)
{
  out.println("<input type='submit' value='审核通过' onclick='f_act(2)' />");
  out.println("<input type='submit' value='取消订单' onclick='f_act(4)' />");
}else if(t.state==2)
{
  out.println("<input type='submit' value='已付款' onclick='f_act(5)' />");
  out.println("<input type='submit' value='取消审核' onclick='f_act(1)' />");
  out.println("<input type='submit' value='取消订单' onclick='f_act(4)' />");
}else if(t.state==3){
	out.println("<input type='submit' value='取消订单' onclick='f_act(4)' />");
}
