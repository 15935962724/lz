...
<form id='form1' name="form1" action="/JihuoCodes.do" method="post"  enctype="multipart/form-data" onSubmit="return mt.check(this)">
<input name='nexturl' type="hidden" value="/jsp/yl/shop/ExpExcelJihuoM.jsp" />
<input name='act' type="hidden" value="uploadfile" />
<table id="tablecenter">
	<tr><td >模板</td><td ><a href="/res/Excel/JihuoCode.xls">点击下载</a></td></tr>
