			...
			<tr id="tableonetr">
				...
				}else
				{
					...
					for(int i=0;i<shlist.size();i++){
						...
						out.print("<tr data='{name:\""+sh.name[1]+"\"}'><td><a href='javascript:void(0);' onclick=ret('"+sh.product+"',this);>"+sh.name[1]+"</a></td><td>"+sh.price+"</td></tr>");
					}
				}
...
<script type="text/javascript">
	...
	function ret(h,t){
		...
		pmt.receive1(h,'productid');
		pmt.receive1(d.name,'productid1');
		pmt.close();
	}
