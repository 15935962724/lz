...
if(!ccp.isReceipt())
{
  response.sendRedirect("/jsp/cio/InfoCioCompany.jsp?alert="+java.net.URLEncoder.encode("您的信息还没有被审核,暂时不能查看人员接送安排.","UTF-8"));
  return;
}
...
<!--img src="/res/cavendishgroup/u/0810/081059220.jpg" border="0"/-->
<h1>查看人员接送安排</h1>
<div id="firstshow">
<br>
...
for(int i=1;e.hasMoreElements();i++)
{
  ...
  out.print("<td id='lig'>"+cck.getSname());
  out.print("<td id='caozuo'>"+cck.getStel());
}
%>
</table>
<div id="shuoming">
