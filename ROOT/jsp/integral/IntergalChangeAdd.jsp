...
<tr><td align="center">用户ID</td><td><input type="text"  size="6" name="member" value="<%=member%>" readonly="readonly"/></td></tr>
<tr><td align="center">积分的金额</td><td><input type="text"  size="6"/></td></tr>
