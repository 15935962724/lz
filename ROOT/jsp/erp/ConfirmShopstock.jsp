      ...
      <META HTTP-EQUIV="Expires" CONTENT="0">
        ...
        <div id="lzi_rkd">
          ...
          <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
            ...
            <tr>
              <td nowrap>收货人</td>
              <td  id="jin2"><% if(pobj.getConsignee()!=null)
              {
                out.print(pobj.getConsignee());
              }
              else if(pobj.getMember2()!=null && pobj.getMember2().length()>0)
              {
                 Profile pobj3 = Profile.find(pobj.getMember2());
                out.print(pobj3.getLastName(teasession._nLanguage)+pobj3.getFirstName(teasession._nLanguage));
              }
            %></td>
            </tr>
            <tr>
            ...
            <tr>
              <td nowrap>电话：</td>
              <td  id="jin2"><% if(pobj.getTel()!=null){out.print(pobj.getTel());}else{out.print(pobj.getTelephone());}%></td>
            </tr>
            <tr>
              <td nowrap>发货时间：</td>
          ...
          <br>
          <input type="submit" value="已经收到货物"/>&nbsp;
