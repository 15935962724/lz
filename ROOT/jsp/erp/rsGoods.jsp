...
function f_c()
{
  var rs = window.showModalDialog('/jsp/erp/rsPaidinfull.jsp?supplnamehidden='+form1.supplnamehidden.value+'&waridname='+form1.waridname.value,self,'edge:raised;scroll:0;status:0;help:0;resizable:0;dialogWidth:857px;dialogHeight:655px;');
  if(rs!=null){
...
<input type="hidden" name="supplnamehidden" value="<%=supplnamehidden%>"/>

<table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
<tr>
<td>
  <font color="#9F0A0E"><b>请填写销售单号查询出要退货的商品:</b></font><input type="text" name="purid" value="<%if(purid!=null&&!"0".equals(purid))out.print(purid);%>">
...
java.util.Enumeration e = GoodsDetails.findPai(teasession._strCommunity,sql.toString(),pos,pageSize);
   ...
   if(!e.hasMoreElements())
   {
     if("0".equals(purid))
     {
       out.print("<tr><td colspan=10 align=center>请先填写销售单的订单号,才能查询到商品!</td></tr>");
     }else
     {
