...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
          ...
          for(int i=0;eu.hasMoreElements();i++)
          {
            ...
            <tr>
             <td nowrap="nowrap"><%=i+1%></td>
              ...
              <td nowrap="nowrap"><input  type="button" value="编辑" onclick="window.open('/jsp/erp/semi/EditSemiGoodsadd.jsp?ids=<%=sgid%>','_self')" /></td>
            </tr>
            <%
          }
          %>
  ...
  <%}  %>
        ...
        <br>
        <input type="button"  value="添加半成品" onclick="window.open('/jsp/erp/semi/EditSemiGoodsadd.jsp','_self')"/>
        </form>
        </body>
</html>
