...
<table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
  ...
  for(int i=0;e.hasMoreElements();i++)
  {
    ...
    <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
      ...
      <td nowrap><input type=button  value=编辑 onclick="window.open('/jsp/erp/semi/EditSemipurchase.jsp?purid=<%=purchase%>','_self')"></td>
    </tr>
    <%
    }
 %>
    ...
    <%}%>
    <tr><td align="center"  colspan="3"><input onclick="window.open('/jsp/erp/semi/EditSemipurchase.jsp','_self')" value="添加商品合成规则" type="button" /></td></tr>
</table>
</form>
</body>
</html>
