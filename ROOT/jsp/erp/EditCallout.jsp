  ...
  <META HTTP-EQUIV="Pragma" CONTENT="no-cache">
    <META HTTP-EQUIV="Cache-Control" CONTENT="no-cache">
      <META HTTP-EQUIV="Expires" CONTENT="0">
        <body bgcolor="#ffffff"   <%if(purid!=null){out.print(" onload=l_ajax_co()");}%>  >
        <script type="">
        ...
        function f_submit()
        {
          ...
          function f_supplname()
          {
            if(form1.waridname.value!=0 && form1.supplname.value==form1.waridname.value)
            {
              alert("调出仓库不能和调入仓库相同，请重新选择！");
              form1.supplname.value=0;
              form1.supplname.focus();
              return false;
            }
          }
          function f_waridname()
          {
            if(form1.supplname.value!=0 && form1.supplname.value==form1.waridname.value)
            {
              alert("调入仓库不能和调出仓库相同，请重新选择！");
              form1.waridname.value=0;
              form1.waridname.focus();
              return false;
            }
          }
          ...
          <div id="lzi_rkd">
            <h1>调拨单</h1>
            <form action="/servlet/EditCallout" method="POST" name="form1" onsubmit="return f_submit();">
            <input type="hidden" name="act" value="EditCallout"/>
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
              <tr>
                <td width="9%">调出仓库：</td>
                <td width="24%">
                  <select name="supplname"  class="lzj_huo" onchange="f_supplname();">
                    ...
                    while(e1.hasMoreElements()){
                      ...
                      Warehouse sobj=Warehouse.find(sid);
                    ...
                    <td nowrap>调入仓库：</td>
                    <td colspan="2"><select name="waridname" class="lzj_huo" onchange="f_waridname();">
            ...
            <span id="show">
              <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
                ...
                <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''"  onclick="f_xuanze_co();" title="点击表格可以添加商品"  style="cursor:pointer">
            ...
            <br>
            <input type="submit" value="<%if(type==1){out.print("审核调拨单");}else{out.print("保存调拨订单");}%>"/>&nbsp;
