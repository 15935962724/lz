...
Distribution pobj =Distribution.find(dibid);
...
<div id="lzi_rkd" style="border:0" >
  <table border="0" cellpadding="0" cellspacing="0" id="tableid1">
    <tr id="lzj_biao_xs">
      <td colspan="3" align="center">配送单</td>
    </tr>
    <tr>
      <td nowrap >录单日期：<%=pobj.getTime_sToString() %></td>
      <td nowrap >单据编号：<%=dibid%></td>
       <td nowrap>配送仓库：<%=Warehouse.find(pobj.getWarid()).getWarname()%></td>
    ...
    <tr>
     ...
     %></td>
      <td nowrap>配送单位：<%=lsobj.getLsname()%></td>
   ...
   <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
              ...
              <%} %>
              <tr>
                <td align="right" colspan="7" nowrap><b>折后数量和金额：</b></td>
