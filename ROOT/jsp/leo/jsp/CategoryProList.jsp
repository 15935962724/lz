...
<div class="title"><span>保护区名录</span><div class="search"><form name="form1" action="/html/papc/folder/13100755-1.htm" method="post">
...
<ul>
	...
	<%
		...
		for (int j = 0; j < key.length; j++) {
			out.print("<li><a href='/html/papc/folder/13100755-1.htm?city="
