...
String href="/html/papc/category/"+MT.f(n.getFather())+"-1.htm";
...
<div class="list">
<ul>
	<li><a href="/html/papc/category/13110233-1.htm">云南高黎贡国家级自然保护区昆虫生态图鉴</a></li>
	<li><a href="/html/papc/category/13115002-1.htm">河北雾灵山国家级自然保护区昆虫生态图鉴</a></li>
	<%-- <%=htmlx.toString() %> --%>
</ul>
</div>