...
sql.append(" AND status=").append(Trade.TRADES_FINISHED);
...
<div id="tablebgnone">
<h1><%=r.getString(teasession._nLanguage, "已完成的订单")%></h1>
...
for(int i=1;e.hasMoreElements();i++)
{
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td><%=obj.getProof()%></td>
    <td><input type=button value="流程图" onclick="f_view('<%=trade%>');"></td>
  </tr>
<%
}
%>
