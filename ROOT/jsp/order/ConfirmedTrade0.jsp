...
<body>
<h1><%=r.getString(teasession._nLanguage, "ConfirmedTrade0")%></h1>
...
<%--    <span id="span_express" style="" >
  ...
  <br/>
  <INPUT  id="radio" type="radio" NAME=Status VALUE=4 onclick="fexpress()" CHECKED>准备发货
  <INPUT  id="radio" type="radio" NAME=Status  VALUE=1 onclick="fexpress()" >取消订单<br>
<%--  发货时间:<%=new tea.htmlx.TimeSelection("unshipped",null,true,true)%>(年-月-日-时-分)<br>
  估计到达时间:<%=new tea.htmlx.TimeSelection("estimate",null,true,true)%>(年-月-日-时-分)<br>--%>
