...
sql.append(" AND status=").append(Trade.TRADES_UNSHIPPED);
...
<div id="tablebgnone">
<h1><%=r.getString(teasession._nLanguage, "已经发货")+"-"+Trade.PS_TYPE[ps]%></h1>
...
<input type="hidden" name="community" value="<%=teasession._strCommunity%>"/>
<input type="hidden" name="act" value="salefinished"/>
...
while(e.hasMoreElements())
{
  ...
  <tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
    ...
    <td><%=obj.getProof()%></td>
    <td><%=obj.getStimeToString()+" / "+obj.getFtimeToString()%></td>
...
<input type="submit" value="完成订单" onclick="return submitCheckbox(form2.trades,'请选中要完成的订单.');"/>
</FORM>
