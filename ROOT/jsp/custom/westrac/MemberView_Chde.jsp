...
<div class="title"><span>发过的贴子</span><a href="/html/folder/14091074-1.htm?member=<%=Http.enc(member)%>">更多</a></div>
<div class="con">
...
<div class="title"><span>回复的贴子</span><a href="/html/folder/14091075-1.htm?member=<%=java.net.URLEncoder.encode(member,"utf-8")%>">更多</a></div>
<div class="con">
<table border="0" cellpadding="0" cellspacing="0">
...
<div class="title"><span>好友列表：</span><a href="/html/folder/14091079-1.htm?member=<%=Http.enc(member)%>">更多>></a></div>
