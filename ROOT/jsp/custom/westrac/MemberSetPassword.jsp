...
%>
  <tr>
    ...
    <td><input type="password" name="old" alt="旧密码"></td>
  </tr>
  <tr>
    <td align="right">新密码：</td>
    <td><input type="password" name="password" alt="新密码"></td>
  </tr>
  <tr>
    <td align="right">确认新密码：</td>
    <td><input type="password" name="password2" alt="确认新密码"></td>
  </tr>
</table>
