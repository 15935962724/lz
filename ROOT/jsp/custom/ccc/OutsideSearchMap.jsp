...
}else
{
  ...
  for(int i=pos;e.hasMoreElements();)
  {
    ...
    if(i%10==0)out.print("</table><table cellspacing='0'><tr id='tableonetr'><td align=center>序号</td><td>名称</td></tr>");
    out.print("<tr class='td"+i%2+"'><td align=center>"+(++i<10?"0":"")+i+"</td><td>"+n.getAnchor(h.language)+"</td></tr>");
  }
  out.print("</table></div>");
