...
while(e.hasMoreElements())
{
  ...
  if(e2.hasMoreElements())
  {
    ...
    out.print("<div style=\"padding-left:10px;background:url(/res/ROOT/u/0709/070946765.gif) repeat-x bottom;color:#797979;padding-bottom:5px;\"><img src=/res/ROOT/u/0709/070921017.jpg align=absmiddle> ");
    if(ei.getNode()>0)
    out.print("<a href=/servlet/Node?node="+ei.getNode()+"&language="+teasession._nLanguage+" target=earth_main><span style=\"font-weight:bolder;font-size:13px;\">");
    out.print(ei.getName()+"</span></a> <span style=\"font-size:12px;\">( "+ip+" )</span><br></div><div id=\"aa\">");

    while(e2.hasMoreElements())
    {
      String host=(String)e2.nextElement();
      EarthHost eh=EarthHost.find(host);
      //Communityinfo.countByHost(host)以前的统计数据


      out.print("<a href=http://"+host+":"+ei.getPort()+"/jsp/admin/earth/EarthDesktop.jsp?community="+teasession._strCommunity+"&ip="+ip+"&host="+host+"&context="+eh.getContext()+" target=earth_main >"+eh.getContext()+" ( "+eh.getCounts()+" )</a><br>");
    }
    out.print("</div><br>");
  }
}
