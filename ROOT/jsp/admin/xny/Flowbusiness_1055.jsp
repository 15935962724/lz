...
{
  if(act=="ajax_opinion")dt="/560,561,562/";
...
function f_load()
{
  ...
  //如果备选文件大于1个，则弹出对话框。
  var v=form1.dynamictype580.value;
  if(v.charAt(0)==':')
  {
    if(v.charAt(v.length-1)==':')v=v.substring(0,v.length-1);
    sel=v.split(':').length==2?v.substring(1):window.showModalDialog('/jsp/admin/flow/SetFlowbusinessDocs.jsp?community=' + form1.community.value + '&field=dynamictype580&t='+new Date().getTime(),self,'dialogWidth:360px;dialogHeight:280px;help:0;status:0;scroll:0;');
...
if(bw||br)
{
  ...
  if(authority)
  {
    out.println("<input type='button' value='盖章' onclick='form1.dynamictype_button580.onclick()' >");
  }
//  if(step==9)
//  {
...
out.println("<input type='button' value='下载' onclick=location.href='/servlet/EditFlowdynamicvalue?act=down&community='+form1.community.value+'&flowbusiness='+form1.flowbusiness.value+'&dynamictype=/580/569/' >");
...
if(dtw.indexOf("/560/")!=-1)
{
  out.println("<input type='button' value='填写意见' onclick=f_opinion('/560/561/562/') />");
}
//会签
//if(dtw.indexOf("/146/")!=-1)
//{
//  fb.setCSign("/","/");//清空领导指定的会签人员
...
//发文字号
if(dtw.indexOf("/570/")!=-1)//||isCreator
{
  out.println("<input type='button' value='文件字号' onclick='xny.code(570)' />");
}
//归档
...
<input type="text" name="dynamictype569" disabled="disabled" />
<input type="text" name="dynamictype560" disabled="disabled" />
<input type="text" name="dynamictype561" disabled="disabled" />
<input type="text" name="dynamictype562" disabled="disabled" />
...
<table id="tabbase"  <%if(ist.equals("1"))out.print("style='display:none'");%>>
  <tr>
    ...
    <td id="td568"><input type="text" name="dynamictype568" id="dynamictype568"/></td>
  </tr>
  <tr>
    <td class="tdtitle">主 题 词</td>
    <td  id="td575"><table class="addbutton"><tr><td class="td1"><input type="text" name="dynamictype575" id="dynamictype575" /></td><td class="td2"><input type="button" value="提取" onClick="f_ajax('ajax_key','575',form1.dynamictype568.value);"/></td></tr></table></td>
  </tr>
  <tr>
    <td class="tdtitle">主　　送</td>
    <td  id="td573"><table class="addbutton"><tr><td class="td1"><input type="text" name="dynamictype573" id="dynamictype573"/></td><td class="td2"><input type="button" value="选择" onClick="f_dept(form1.dynamictype573);"/></td></tr></table></td>
  </tr>
  <tr>
    <td class="tdtitle">抄　　报</td>
    <td  id="td574"><table class="addbutton"><tr><td class="td1"><input type="text" name="dynamictype574" id="dynamictype574"/></td><td class="td2"><input type="button" value="选择" onClick="f_dept(form1.dynamictype574);"/></td></tr></table></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td id="td570"><input type="text" readonly="readonly" style="background:transparent;border:0;width:90%;" name="dynamictype570"/></td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td  class="tabtdteshu" id="td571" title="机密程度: 机密 秘密 ">
    <%
    dynamictype=571;
    out.print("<input type='hidden' name='dynamictype" + dynamictype + "' />");
    dt=DynamicType.find(dynamictype);
  ...
  <tr>
    ...
    <table id="tabbase_nei" border="0" cellspacing="0" cellpadding="0">
    <tr class="out2">
    <td class="tabtdteshu" id="td563"><input type="text" name="dynamictype563" /><img src="/tea/image/public/blank_png.gif" style="display:none" oncontextmenu="return false"/></td>
    <td class="tdtitle">拟稿日期</td>
    <td id="td565"><input type="text" name="dynamictype565" onclick='showCalendar(this,true)' readonly='true'  /></td>
    </tr>
    </table>
    </td>
  </tr>
...
<img id="imgmap" src="/tea/flow/<%=flow==13?6:(flow==14?7:flow)%>.jpg" usemap="#Map" />
