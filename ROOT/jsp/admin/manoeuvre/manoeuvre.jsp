...
<html>
  ...
  function editimd(igd)
  {
    ...
    form1.action='/jsp/admin/manoeuvre/EditManoeuvre.jsp';
    form1.submit();
  }
      ...
      <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
        ...
        while(e.hasMoreElements())
        {
          ...
          <td width="20" align="center"><%=index %></td>
            ...
            %></td>
            <td align="center" ><input  type ="button"  value="编辑" onClick="editimd('<%=manoeuvre%>');">
              <input type=button value="删除"  onClick="deleteimd('<%=manoeuvre%>');">
            </td>
          </tr>
          <%
          index++;
...
<br>
<input  type ="button" name="newbulletin" value="添加人事调动" onClick="editimd(0);">
