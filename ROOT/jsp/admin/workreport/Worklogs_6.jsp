...
int count = 0; //Worklog.count(community, sql.toString());
count = Worklog.count(community," AND workproject="+workproject +" and  sumupreport ="+1);
        ...
        <META HTTP-EQUIV="Cache-Control" CONTENT="no-cache">
          <META HTTP-EQUIV="Expires" CONTENT="0">
            ...
            <form name=form2 METHOD=get action="/jsp/admin/workreport/SendWorklog.jsp">
              ...
              <h2><%=r.getString(teasession._nLanguage,"1168575045718")+"( "+count+" )"%>  <!--列表-->
              </h2>
              <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
                <tr id="tableonetr">
                  ...
                  <td nowrap>
                    <!--时间-->
                    <%out.print(r.getString(teasession._nLanguage, "时间/总结人"));    %>
                  </td>
                  <td nowrap>
