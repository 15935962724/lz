...
%>
<form name=form1 method="POST" action="/jsp/admin/workreport/<%=pages%>" onSubmit="" target="Worklogs_10" style="margin-top:15px">
 <input name="querykey" value="" style="padding-top:2px">
 <input onClick="ResponseWorklogs('<%=pages%>','6');" type="submit" value="GO"/>
</form>
