...
<body class="bodycolor" onMouseover="borderize_on(event);" onMouseout="borderize_off(event);" onclick="borderize_on1(event);" topmargin="5">
 <table border="0" cellpadding="0" cellspacing="0" id="tablecenter">
   ...
   <%
   java.util.Enumeration un = AdminUnit.findByCommunity(teasession._strCommunity," ");
   while (un.hasMoreElements())
   {
     AdminUnit adminunit=(AdminUnit)un.nextElement();
     int units=adminunit.getId();


     %><tr><td><h2><%=adminunit.getName()%></h2></td><tr><%
     java.util.Enumeration me = AdminUsrRole.find(teasession._strCommunity," and role !='/'  and unit="+units,0,Integer.MAX_VALUE);
     while(me.hasMoreElements())
     {
       String _member = ((String)me.nextElement());
