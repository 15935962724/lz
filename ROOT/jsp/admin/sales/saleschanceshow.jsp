...
<form mothod="post" name="form2" action="/jsp/admin/sales/saleschanceshow.jsp">
...
<td>
	...
	<input type="button" value="测试"  onClick="location='/jsp/admin/sales/saleschanceshow.jsp'">
</td>
</tr>
<tr>
	<td>业务机会名称 </td>
...
<tr onMouseOver="javascript:this.bgColor='#BCD1E9'" onMouseOut="javascript:this.bgColor=''">
	 ...
	 <td nowrap><a href="/jsp/admin/sales/saleschanceinfo.jsp?laid=<%=laid%>"><%=tsdbj.getClientname()%></a> </td>
