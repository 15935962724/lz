...
<tr> 
  ...
  <td><input type="password" name="EnterPassword" value="<%if(EnterPassword!=null)out.print(EnterPassword);%>"/>&nbsp;&nbsp;<span id="passwordshow">&nbsp;</span>
  </td>
  <td >
    <%
...
<tr>
  ...
  <td><input type="password" name="ConfirmPassword" value="<%if(EnterPassword!=null)out.print(EnterPassword); %>"/>&nbsp;&nbsp;<span id="confirmpasswordshow">&nbsp;</span></td>
   <td>
