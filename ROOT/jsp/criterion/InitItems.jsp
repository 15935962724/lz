...
StringBuffer sql=new StringBuffer(" AND states IN(0,1) ");
/*
...
--%>
                  ...
                  <td nowrap><%=obj.getInittimeToString()%>&nbsp;</td>
                  <td>
<input type="button" value="<%=r.getString(teasession._nLanguage,"CBEdit")%>" onClick="window.location='/jsp/criterion/InitEditItem.jsp?item=<%=item%>&community=<%=community%>&nexturl=<%=nexturl%>';"/>
                 </td>
 </tr>
  <%
}
