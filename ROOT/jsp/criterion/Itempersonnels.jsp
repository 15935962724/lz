<%@page contentType="text/html;charset=UTF-8" %><%@ page import="tea.db.DbAdapter"  %><%@ page import="tea.resource.Resource"  %><%@ page  import="tea.entity.criterion.Itemoutlay"  %><%@ page  import="tea.entity.criterion.Item"  %><%@ page  import="tea.entity.criterion.*" %><%@ page import="tea.ui.TeaSession" %><%
...
//人员信息：项目计划号、编制单位名称、经办人、标准所管理员、“人员联系信息”，“人员联系信息”点击后，显示各人员的基本信息：姓名、单位、角色、职务、电话、手机、邮件；
%>
<html>
<head>
