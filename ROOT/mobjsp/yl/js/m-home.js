...
$(".tab_per_tit span").click(function(){
    var i = $(this).index();
    $(".tab_per_txt").eq(i).show().siblings('.tab_per_txt').hide();
    $(this).addClass('tab_per_tit_active').siblings().removeClass('tab_per_tit_active');
})