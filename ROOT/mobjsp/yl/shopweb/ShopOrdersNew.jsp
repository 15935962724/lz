...
//按医院查询
    ...
    sql.append("AND orderType=0");//粒子订单type
        ...
        <div class="order-list">
           ...
           <ul class="ft14">
               ...
               <li>
                   ...
                   <span class="list-spanr fl-left"><%=odata.getQuantity()-t.getIsinvoicenum() %></span>
               </li>
               <li>
           ...
           <p class="order-btnp">
                            ...
                            <%
                                ...
                                if(status==0&&profile.membertype!=0)//签收人不能取消订单操作
                                ...
                                if(status==4){
                                    ...
                                    if(m.membertype == 2||m.membertype==0){//签收人也可以打印
                                        out.println("<a  class='btn' onclick=\"mt.act('printOrder','"+t.getOrderId()+"');\" >打印发货单</a>");
                                    }
                                }
    ...
    mt.act=function(a,orderId,status,statusContent)
    {
        ...
        }else if(a=='status')
        {
            ...
            if(status==5){
                ...
                mt.show("<textarea id='_content' cols='33' rows='6' title='取消订单'></textarea>",2,'取消订单',348);
                mt.ok=function()
                {
                    var t=$$('_content');
                     if(t.value=='')
