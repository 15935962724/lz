...
<div class='detail'>
		...
		if(product>0)
			out.println("<a href='javascript:void(0);' onclick=parent.location='/xhtml/folder/14110010-1.htm?product="+product+"' class='backBuy'>立即订购 </a>");
		else
			out.println("<a href='/xhtml/folder/14110071-1.htm' target='_blank' class='backBuy'>如何授权 </a>");
		out.println("</li></ul>");
		%>
