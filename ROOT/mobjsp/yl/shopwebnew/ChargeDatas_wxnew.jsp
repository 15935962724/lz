...
<body>
<header class="header">服务费管理详情</header>
...
<%
	String[] backids=charge.getBackid().split(",");//BackInvoice的id
%>
...
<div class="resultlist">
	...
	<%
		...
		for(int a=0;a<backids.length;a++){
			int backid=Integer.parseInt(backids[a]);
	    ...
	    %>
	    	<ul>
	    		<li>
	    			...
	    			<span><%=ReplyMoney.typeARR[reply.getType()] %></span>
	    		</li>
	    		<li>
