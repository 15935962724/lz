...
try {
	...
	while (rs.next()) {
		...
		htmlz.append("<li><a href=\"/xhtml/papc/plant/"+node+"-1.htm\" >"+f+" </a></li>");
...
%>
		...
		<hr/>--%>
		<div class="search1">
        <form name="form1" action="/xhtml/papc/category/13113871-1.htm" method="post">
			<table cellspacing="0" cellpadding="0" border="0" class="tab1">
                ...
                <tr>
					<td class="th">科目名：</td>
					<td colspan="2">
						<input type="text" name="family1" id="family1" value="<%=family1 %>"/>
					</td>
                </tr>
                <tr>
					<td class="th">物种名：</td>
					<td>
						<input type="text" name="species1" id="species1" value="<%=species1 %>"/>
					</td>
					<td class="th">
