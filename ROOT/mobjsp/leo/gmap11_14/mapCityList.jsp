...
*/
  ...
  var u=location.href;
  link.setHref(u.substring(0,u.indexOf('/',10))+'/res/papc/structure/earth.kmz?t='+new Date().getTime());
...
<div class="title"><span>保护区名录</span><div class="search"><form name="form1" action="/html/papc/folder/13110231-1.htm" method="post">
		...
		</form></div><div class="arrangement" style="text-align:right;padding-right:20px;"><a href="/html/papc/folder/946895-1.htm" target="_blank" style="color:#228C00;font-weight:bold;">地球模式</a></div></div>
<div class="list">
<ul>
		
	<%
		if(map.isEmpty()){
			out.print("<div>暂无记录！</div>");
		}else{
			Object[] key = map.keySet().toArray();
			Arrays.sort(key);
			for (int j = 0; j < key.length; j++) {
				out.print("<li><a href='/html/papc/folder/13110231-1.htm?city="
