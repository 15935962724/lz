// Decompiled by DJ v2.9.9.60 Copyright 2000 Atanas Neshkov  Date: 2004-9-24 15:15:05
// Home Page : http://members.fortunecity.com/neshkov/dj.html  - Check often for new version!
// Decompiler options: packimports(3)
// Source File Name:   Bargains.java
...
public class Bargains extends TeaServlet
{
    ...
    public void service(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        try
        {
            ...
            qs = qs == null ? "" : "?" + qs;
            response.sendRedirect("/jsp/offer/Bargains.jsp" + qs);
            ...
            Row row;
            for(Enumeration enumeration = Bargain.findNodes(teasession._rv,i,25);enumeration.hasMoreElements();table.add(row))
            {
            ...
            printwriter.print(new FPNL(teasession._nLanguage,"Bargains?Pos=",i,j));
    ...
    public void init(ServletConfig servletconfig) throws ServletException
    {
        ...
        super.r.add("tea/ui/member/offer/Offers").add("tea/ui/member/offer/Bargains");
    }
}
