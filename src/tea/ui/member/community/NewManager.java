...
public class NewManager extends TeaServlet
{
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            {
                response.sendRedirect("/jsp/community/NewManager.jsp?Community=" + s);
                /*
                                Form form = new Form("foNew", "POST", "NewManager");
            ...
            {
                String s1;
                for (StringTokenizer stringtokenizer = new StringTokenizer(request.getParameter("Members"), " ,"); stringtokenizer.hasMoreTokens(); Manager.create(s, s1))
                {
