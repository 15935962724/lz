...
public class Spell
{
    ...
    public Spell(char cn) throws SQLException
    {
        this.cn = cn;
        load();
    }

    public Spell() throws SQLException
    {
    ...
    private void load() throws SQLException
    {
        ...
        try
        {
            db.executeQuery("SELECT spell FROM spell WHERE cn=" + DbAdapter.cite(String.valueOf(cn)));
            if (db.next())
            {
                spell = db.getString(1);
                exists = true;
            } else
            {
                spell = String.valueOf(cn);
                exists = false;
            }
        } finally
        {
    ...
    public static Spell find(char cn) throws SQLException
    {
        return new Spell(cn);
    }
    ...
    public static String getSpell(String str) throws SQLException
    {
        char ch[] = str.toCharArray();
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < ch.length; i++)
        {
            sb.append(Spell.find(ch[i]).getSpell()).append(" ");
        }
        return sb.toString();
    }
    /*
      ...
      for (int i = 0; i < ch.length; i++)
      {
        sb.append(getSpell(ch[i])).append(" ");
      }
      return sb.toString();
       }
